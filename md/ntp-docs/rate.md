...
![gif](pic/boom4.gif) [from _Pogo_, Walt Kelly](http://www.eecis.udel.edu/%7emills/pictures.html)
...
- [Introduction](#intro)
- [Minimum Headway Time](#guard)
- [Minimum Average Headway Time](#mah)
- [The Kiss-o'-Death Packet](#kiss)
- [References](#ref)
...
1. Mills, D.L., J. Levine, R. Schmidt and D. Plonka. Coping with overload on the Network Time Protocol public servers._Proc. Precision Time and Time Interval (PTTI) Applications and Planning Meeting_ (Washington DC, December 2004), 5-16. Paper: [PDF](http://www.eecis.udel.edu/~mills/database/papers/ptti/ptti04a.pdf), Slides: [PDF](http://www.eecis.udel.edu/~mills/database/brief/ptti/ptti04.pdf) \| [PowerPoint](http://www.eecis.udel.edu/~mills/database/brief/ptti/ptti04.ppt)
