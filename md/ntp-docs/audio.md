...
![jpg](pic/radio2.jpg)ICOM R-72 shortwave receiver and Sure audio mixer
...
- [Sound Card Drivers](#sound)
- [Shortwave Radio Drivers](#short)
- [Setup and Debugging Aids](#setup)
...
All three drivers make ample use of sophisticated digital signal processing
...
are further analyzed, modeled and evaluated in a technical report.
...
- Transitions between daytime and nighttime conditions generally occur somewhat
...
RadioHexDecimalRadioHexDecimal7060x4e787750x4670706MKIIG0x58887810x26387250x28409700x2e467260x304870000x701137350x044R710x1A267460x66102R720x32507510x1c28R750x5a90756PROII0x64100R70000x0887610x1e30R71000x34527650x2c44R85000x4a74R90000x2a42
...
the line-in port can handle..

It is very easy to underdriven or overdrive the audio codec, in which case
the drivers will not synchronize to the signal. The drivers use fudge
flag2 to enable audio monitoring of the input signal. This is useful
...
volume must be set before the driver is started.
