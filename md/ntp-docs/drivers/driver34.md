...
Serial Port: /dev/wwvb _u_; 9600 bps, 8-bits, no parity

Features: (none)

#### Description

This driver supports the Ultralink Model 325 (replacement for Model 320) RS-232 powered WWVB receiver. PDF specs available on [http://www.ulio.com/](http://www.ulio.com/). This driver also supports the Model 320, 330,331,332 decoders in both polled or continous time code mode.Leap second and quality are supported. Most of this code is originally from refclock\_wwvb.c with thanks. Any mistakes are mine. Any improvements are welcome.

#### Model 325 timecode format

<cr><lf>RQ\_1C00LYYYY+DDDUTCS\_HH:MM:SSL+5
