...
This driver supports at least some models of the [Rockwell Jupiter GPS receivers](http://www.navman.com/oem/products/receivers/jupiter/) (Jupiter 11, Jupiter-T), they must at least support the _Zodiac Binary Protocol_.
...
time1 _time_Specifies the time offset calibration factor, in seconds and fraction, with default 0.0.
 time2 _time_Not used by this driver. Should be left at zero.
 ...
 flag2 0 \| 1Specifies the mobility of the GPS receiver: 0 for walking (default), 1 for driving.
 flag3 0 \| 1Specifies the PPS signal on-time edge: 0 for assert (default), 1 for clear.
