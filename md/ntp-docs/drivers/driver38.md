...
**9600 baud, 8-bits, 1-stop, no parity**![gif](../pic/fg6021.gif)

* * *

## Description

The **refclock\_hopf\_serial** driver supports [hopf electronic receivers](http://www.hopf.com) with serial Interface kompatibel 6021.
...
## O/S Serial Port Configuration
 ...
 The driver attempts to open the device **[/dev/hopfclock _X_](#REFID)** where _**X**_ is the NTP refclock unit number as defined by the LSB of the refclock address.  Valid refclock unit numbers are 0 - 3.
...
**time1 _time_**Specifies the time offset calibration factor, in seconds and fraction, with default 0.0. Should be set to 20 milliseconds to correct serial line and operating system delays incurred in capturing time stamps from the synchronous packets.
...
as specified in clock manual under pt. [ **Data String for NTP** ( **_Network Time Protocol_**) ]
