...
* **SA_RESTORER**  
  _Not intended for application use_.
...
_si_signo_, _si_errno_ and _si_code_
...
* *  
  ...
  **sigqueue**(3)
  fill in
  _si_pid_ and _si_uid_.
  In addition, signals sent with
  **sigqueue**(3)
  fill in
  _si_int_ and _si_ptr_
...
* *  
  **SIGCHLD**
  fills in
  _si_pid_, _si_uid_, _si_status_, _si_utime_, and _si_stime_,
