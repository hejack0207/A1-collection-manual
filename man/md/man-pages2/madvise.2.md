...
#include <sys/mman.h> 
 ...
 madvise(): .RS 4 .TP 4 Since glibc 2.19: _DEFAULT_SOURCE .TP Up to and including glibc 2.19: _BSD_SOURCE .RE
```
...
<a name="conventional-advice-values"></a>
...
<a name="linux-specific-advice-values"></a>
