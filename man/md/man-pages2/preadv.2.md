...
```
 ...
 preadv(), pwritev():     Since glibc 2.19:         _DEFAULT_SOURCE     Glibc 2.19 and earlier:         _BSD_SOURCE
```
...
<a name="historical-c-librarykernel-differences"></a>
