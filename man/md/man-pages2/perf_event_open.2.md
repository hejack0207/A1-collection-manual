...
* **pid == -1** and **cpu &gt;= 0**  
  ...
  **CAP_SYS_ADMIN**
  capability or a
  _/proc/sys/kernel/perf_event_paranoid_
  ...
  It has one of the following values:
    ...
    * dynamic PMU  
      ...
      **perf_event_open**()
      ...
      _/sys/bus/event_source/devices_.
      ...
      field.
      For instance,
      _/sys/bus/event_source/devices/cpu/type_
    ...
    * **kprobe** and **uprobe** (since Linux 4.17)  
      ...
      See fields
      _kprobe_func_, _uprobe_path_, _kprobe_addr_, and _probe_offset_
      for more details.
* _size_  
  The size of the
  _perf_event_attr_
  ...
  Set this using
  _sizeof(struct perf_event_attr)_
...
_config_,
see
_/sys/bus/event_source/devices/[k,u]probe/format/retprobe_)
...
* _sample_type_  
  ...
  **mmap**(2).
  ...
  it is not the
  _enum perf_event_sample_format_
  order.
    * **PERF_SAMPLE_IP**  
...
* _watermark_  
  ...
  _wakeup_events_
  samples.
* _precise_ip_ (since Linux 2.6.35)  
...
* _mmap_data_ (since Linux 2.6.36)  
...
* .in +4n
  ...
  .EE
  ,in
* _exclude_host_ (since Linux 3.2)  
...
* _exclude_guest_ (since Linux 3.2)  
  ...
  **ioctl**(2)),
  ...
  not change counts gathered inside of a guest.
  Currently, this functionality is x86 only.
* _exclude_callchain_kernel_ (since Linux 3.7)  
  
  Do not include kernel callchains.
* _exclude_callchain_user_ (since Linux 3.7)  
...
* _context_switch_ (since Linux 4.3)  
  ...
  **PERF_RECORD_SWITCH_CPU_WIDE**
  ...
  _perf_event_paranoid_
  settings.
* _wakeup_events_, _wakeup_watermark_  
...
* _config2_ (since Linux 2.6.39)  
  ...
  _config1_
  field.
* _branch_sample_type_ (since Linux 3.4)  
...
* _sample_regs_user_ (since Linux 3.7)  
  ...
  _arch/ARCH/include/uapi/asm/perf_regs.h_.
* _sample_stack_user_ (since Linux 3.7)  
...
* _clockid_ (since Linux 4.1)  
  ...
  **CLOCK_TAI**
  currently supported.
* _aux_watermark_ (since Linux 4.1)  
  
  This specifies how much data is required to trigger a
  **PERF_RECORD_AUX**
  sample.
* _sample_max_stack_ (since Linux 4.8)  
...
* _cap_usr_time_ / _cap_usr_rdpmc_ / _cap_bit0_ (since Linux 3.4)  
...
* Starting with Linux 3.12, these are renamed to
  ...
  _cap_user_rdpmc_
  fields instead.
* _cap_bit0_is_deprecated_ (since Linux 3.12)  
...
* _cap_user_rdpmc_ (since Linux 3.12)  
...
* .in +4n
  ...
  .EE
  .in
* _time_shift_, _time_mult_, _time_offset_  
* If
  _cap_usr_time_,
...
* _time_zero_ (since Linux 3.12)  
  
* If
  _cap_usr_time_zero_
  is set, then the hardware clock (the TSC timestamp counter on x86)
  can be calculated from the
  _time_zero_, _time_mult_, and _time_shift_ values:
...
* The
  ...
  _sample_regs_user_
  bit mask.
* _size_, _data[size]_, _dyn_size_  
  If
  **PERF_SAMPLE_STACK_USER**
...
<a name="perf_event-ioctl-calls"></a>
...
<a name="perf_event-related-configuration-files"></a>
...
* The existence of the
  ...
  **perf_event_open**().
* _/proc/sys/kernel/perf_event_max_sample_rate_  
...
* _/sys/bus/event_source/devices/*/type_ (since Linux 2.6.38)  
...
* _/sys/bus/event_source/devices/cpu/rdpmc_ (since Linux 3.4)  
...
* _/sys/bus/event_source/devices/*/format/_ (since Linux 3.4)  
...
* The content of each file is the name of the config field, followed
  ...
  of
  _perf_event_attr::config1_.
* _/sys/bus/event_source/devices/*/events/_ (since Linux 3.4)  
...
* _/sys/bus/event_source/devices/*/uevent_  
  This file is the standard kernel device interface
  for injecting hotplug events.
* _/sys/bus/event_source/devices/*/cpumask_ (since Linux 3.7)  
...
* **EPERM**  
  ...
  _exclude_hv_, _exclude_idle_, _exclude_user_, or _exclude_kernel_
