...
.in +4
.EX
**long clone(unsigned long **_flags_**, void ***_child_stack_**,**
**           int ***_ptid_**, int ***_ctid_**,**
**           unsigned long **_newtls_**);**
.EE
.in
...
.EX
**long clone(unsigned long **_flags_**, void ***_child_stack_**,**
**          int ***_ptid_**, unsigned long **_newtls_**,**
**          int ***_ctid_**);**
.EE
.in
...
.in +4
.EX
**long clone(void ***_child_stack_**, unsigned long **_flags_**,**
**           int ***_ptid_**, int ***_ctid_**,**
**           unsigned long **_newtls_**);**
.EE
.in
...
.EX
**long clone(unsigned long **_flags_**, void ***_child_stack_**,**
**           int **_stack_size_**,**_         /* Size of stack */_
**           int ***_ptid_**, int ***_ctid_**,**
**           unsigned long **_newtls_**);**
.EE
.in
...
<a name="blackfin-m68k-and-sparc"></a>
...
* **EPERM**  
  ...
  **CLONE_NEWPID**,
  or
  **CLONE_NEWUTS**
  was specified by an unprivileged process (process without **CAP\_SYS\_ADMIN**).
* **EPERM**  
  **CLONE_PID**
