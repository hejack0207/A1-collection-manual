...
structure.
These are marked _//&nbsp;MORE_ and documented further in a
separate section.

This list is very incomplete.

<a name="ioctl-structure"></a>
...
See  
//
_https://wireless.wiki.kernel.org/en/developers/documentation/nl80211_
.TS
l l l.
...
_const struct cdrom_read_audio&nbsp;*_.
The
_buf_
field points to an output buffer of length
_nframes&nbsp;* CD_FRAMESIZE_RAW_.
...
**FDRAWCMD**
takes a
_struct floppy raw_cmd&nbsp;*_.
If
_flags & FD_RAW_WRITE_
is nonzero, then
_data_
...
**PIO_FONTX**
take a
_struct console_font_desc&nbsp;*_
or a
_const struct console_font_desc&nbsp;*_,
respectively.
_chardata_
...
**PIO_UNIMAP**
take a
_struct unimapdesc&nbsp;*_
or a
_const struct unimapdesc&nbsp;*_,
respectively.
_entries_
points to a buffer of
_struct unipair [entry_ct]_.
This is an output buffer for
**GIO_UNIMAP**
and an input buffer for
**PIO_UNIMAP**.
