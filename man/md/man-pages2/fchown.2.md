...
```
 ...
 fchown(), lchown(): .RS 4 /* Since glibc 2.12: */ _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L     || _XOPEN_SOURCE&nbsp;>=&nbsp;500
</synopsis>

<synopsis>
    || /* Glibc versions <= 2.19: */ _BSD_SOURCE .RE 
 fchownat(): .RS 4 .TP 4 Since glibc 2.10: _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L .TP Before glibc 2.10: _ATFILE_SOURCE .RE
```
...
<a name="ownership-of-new-files"></a>
