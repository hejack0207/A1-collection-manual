...
#include <sys/wait.h> 
 ...
 waitid(): .RS 4 Since glibc 2.26: _XOPEN_SOURCE >= 500 ||
</synopsis>

<synopsis>
    _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L
Glibc 2.25 and earlier:     _XOPEN_SOURCE         || /* Since glibc 2.12: */ _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L         || /* Glibc versions <= 2.19: */ _BSD_SOURCE .RE
```
...
and
**waitpid**()
store status information in the _int_ to which it points.
...
* **ECHILD**  
  ...
  **SIGCHLD**
  is set to
  **SIG_IGN**.
  See also the _Linux Notes_ section about threads.)
* **EINTR**  
  **WNOHANG**
