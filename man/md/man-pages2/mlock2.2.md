...
* **EINVAL**  
  Unknown _flags_ were specified.

For
**mlockall**():

* **EINVAL**  
  Unknown _flags_ were specified or
  **MCL_ONFAULT**
...
is defined in _&lt;unistd.h&gt;_ and the number of bytes in a page
can be determined from the constant
**PAGESIZE**
(if defined) in _&lt;limits.h&gt;_ or by calling
