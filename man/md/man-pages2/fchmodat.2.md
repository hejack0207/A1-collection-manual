...
```
 ...
 fchmod(): .RS 4 Since glibc 2.24:     _POSIX_C_SOURCE&nbsp;>=&nbsp;199309L
</synopsis>
...
<synopsis>
.RE 
 fchmodat(): .RS 4 .TP 4 Since glibc 2.10: _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L .TP Before glibc 2.10: _ATFILE_SOURCE .RE
```
