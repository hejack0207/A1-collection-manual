...
<a name="duplicating-a-file-descriptor"></a>
...
* See
  **dup**(2)
  for further details.
* **F_DUPFD_CLOEXEC** (_int_; since Linux 2.6.24)  
  As for
  **F_DUPFD**,
...
<a name="advisory-record-locking"></a>
...
The
_l_whence_, _l_start_, and _l_len_
...
* If one or more incompatible locks would prevent
  ...
  **fcntl**()
  ...
  _l_type_, _l_whence_, _l_start_, and _l_len_
  fields of
  _lock_.
...
<a name="open-file-description-locks-non-posix"></a>
...
* **F_GETOWN_EX** (_struct f_owner_ex *_) (since Linux 2.6.32)  
...
* The
  ...
  **F_SETOWN_EX**
  for more details.
* **F_SETOWN_EX** (_struct f_owner_ex *_) (since Linux 2.6.32)  
...
<a name="file-and-directory-change-notification-dnotify"></a>
...
<a name="changing-the-capacity-of-a-pipe"></a>

### Changing the capacity of a pipe


* **F_SETPIPE_SZ** (_int_; since Linux 2.6.35)  
...
* Attempting to set the pipe capacity smaller than the amount
  ...
  **EBUSY**.
* **F_GETPIPE_SZ** (_void_; since Linux 2.6.35)  
...
* **F_ADD_SEALS** (_int_; since Linux 3.17)  
  ...
  **F_SEAL_SEAL**
  ...
  _fd_
  must be writable.
* **F_GET_SEALS** (_void_; since Linux 3.17)  
...
* **F_GET_RW_HINT** (_uint64_t *_; since Linux 4.13)  
  Returns the value of the read/write hint associated with the underlying inode
  referred to by
  _fd_.
* **F_SET_RW_HINT** (_uint64_t *_; since Linux 4.13)  
...
<a name="record-locking-and-nfs"></a>
...
_/proc/fs/nfsd/nfsv4leasetime_,
...
_locks.txt_,
_mandatory-locking.txt_,
and
_dnotify.txt_
in the Linux kernel source directory
_Documentation/filesystems/_
