...
<a name="nested-namespaces-namespace-membership"></a>
...
<a name="effect-of-capabilities-within-a-user-namespace"></a>
...
<a name="interaction-of-user-namespaces-and-other-types-of-namespaces"></a>
...
<a name="user-and-group-id-mappings-uid_map-and-gid_map"></a>
...
<a name="defining-user-and-group-id-mappings-writing-to-uid_map-and-gid_map"></a>
...
<a name="interaction-with-system-calls-that-change-process-uids-or-gids"></a>
...
<a name="the-procpidsetgroups-file"></a>
...
<a name="unmapped-user-and-group-ids"></a>
...
<a name="operation-of-file-related-capabilities"></a>
...
<a name="set-user-id-and-set-group-id-programs"></a>
...
#define fpe(str) fprintf(stderr, "    %s", str);
    ...
    fpe("-z          Map user's UID and GID to 0 in user namespace\en");
    fpe("            (equivalent to: -M '0 &lt;uid&gt; 1' -G '0 &lt;gid&gt; 1')\en");
...
_Documentation/namespaces/resource-control.txt_.
