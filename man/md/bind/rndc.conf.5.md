...
**server**
statement, this default key will be used to authenticate the servers commands and responses. The
**default-port**
...
**rndc**
to use; currently only HMAC-MD5 (for compatibility), HMAC-SHA1, HMAC-SHA224, HMAC-SHA256 (default), HMAC-SHA384 and HMAC-SHA512 are supported. This is followed by a secret clause which contains the base-64 encoding of the algorithms authentication key. The base-64 string is enclosed in double quotes.
...
Copyright © 2000, 2001, 2004, 2005, 2007, 2013-2016, 2018-2021 Internet Systems Consortium, Inc. ("ISC")  
