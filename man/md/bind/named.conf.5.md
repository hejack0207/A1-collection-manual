...
**named**. Statements are enclosed in braces and terminated with a semi-colon. Clauses in the statements are also semi-colon terminated. The usual comment styles are supported:
...
Copyright © 2004-2021 Internet Systems Consortium, Inc. ("ISC")  
