...
```
.HP \w'mysqlcheck&nbsp;[options]&nbsp;[db_name&nbsp;[tbl_name&nbsp;...]]&nbsp;'u mysqlcheck [options] [db_name [tbl_name ...]]
```
...
Using one **--verbose** option will give you more information about what mysqlcheck is 
doing.
