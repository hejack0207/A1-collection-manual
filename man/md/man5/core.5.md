...
<a name="naming-of-core-dump-files"></a>
...
* %h  
  hostname (same as _nodename_ returned by **uname**(2))
* %i  
...
<a name="piping-core-dumps-to-a-program"></a>
...
* *  
  ...
  pathname relative to the root directory, _/_),
...
<a name="procsyskernelcore_pipe_limit"></a>
...
_/proc/&lt;crashing-PID&gt;_).
The default value for this file is 0.


<a name="controlling-which-mappings-are-written-to-the-core-dump"></a>

### Controlling which mappings are written to the core dump

Since kernel 2.6.23, the Linux-specific
_/proc/[pid]/coredump_filter_
...
<a name="core-dumps-and-systemd"></a>
...
$** su**
Password:
#** echo "|$PWD/core_pattern_pipe_test %p UID=%u GID=%g sig=%s" &gt; \e**
**    /proc/sys/kernel/core_pattern**
#** exit**
$** sleep 100**
**^\e**                     # type control-backslash
Quit (core dumped)
$** cat core.info**
argc=5
