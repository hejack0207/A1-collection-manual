...
* can be augmented with a **--sort** option, but any
  use of **--sort**=_none_ (**-U**) disables grouping
* **-G**, **--no-group**  
...
* **--time**=_WORD_  
  ...
  as sort key if **--sort**=_time_ (newest first)
* **--time-style**=_TIME\_STYLE_  
...
with **--color**=_never_.  With **--color**=_auto_, ls emits color codes only when
