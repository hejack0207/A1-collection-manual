...
* **--time-format** _format_  
  Print timestamps using the given _format_, which can be
  **ctime**,
  **reltime**,
  **delta**
  or
...
Implicit coloring can be disabled by an empty file _/etc/terminal-colors.d/dmesg.disable_.
See
**terminal-colors.d**(5)
...
.MT [tytso@athena.mit](mailto:tytso@athena.mit).edu
Theodore Ts'o
.ME
