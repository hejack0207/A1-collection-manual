...
_program_. If _program_ is not given, then \`\`${SHELL}'' is run (default: /bin​/sh).
...
* **mount namespace**  
  ...
  **mount --make-​shared**; see _/proc​/self​/mountinfo_ for the
  **shared** flag).
...
.UR [biederm@xmission.com](mailto:biederm@xmission.com)
Eric Biederman
.UE  
