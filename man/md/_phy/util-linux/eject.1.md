...
The device corresponding to _device_ or _mountpoint_ is ejected.  If no
...
UUID=_uuid_ or LABEL=_label_ tags.
...
The **-r**, **-s**, **-f**, and **-q** options allow controlling
...
**--no-partitions-unmount**).  If an unmount fails, the program will not
