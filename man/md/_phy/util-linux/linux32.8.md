...
For example, on an AMD64 system, running **setarch i386 program**
will cause _program_ to see i686 instead of x86_64 as the machine type.
...
.MT [sopwith@redhat.com](mailto:sopwith@redhat.com)
Elliot Lee
.ME  
.MT [jnovy@redhat.com](mailto:jnovy@redhat.com)
Jindrich Novy
.ME  
