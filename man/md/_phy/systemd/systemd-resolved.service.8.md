...
* ·  
  ...
  **systemd-resolved**
  ...
  \m[blue]**API Documentation**\m[]\s-2\u[1]\d\s+2
...
* ·  
  ...
  **getaddrinfo**(3)
  API as defined by
  \m[blue]**RFC3493**\m[]\s-2\u[2]\d\s+2
...
* ·  
  ...
  ".local"
  in a DNS server, as
  \m[blue]**RFC6762**\m[]\s-2\u[3]\d\s+2
...
See the
\m[blue]**resolved D-Bus API Documentation**\m[]\s-2\u[1]\d\s+2
for information about the APIs
systemd-resolved
provides.

<a name="etcresolvconf"></a>
