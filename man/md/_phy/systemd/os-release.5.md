...
os-release
please refer to the
\m[blue]**Announcement of /etc/os-release**\m[]\s-2\u[1]\d\s+2.
...
\m[blue]**Common Platform Enumeration Specification**\m[]\s-2\u[2]\d\s+2
as proposed by the NIST. This field is optional. Example:
"CPE_NAME="cpe:/o:fedoraproject:fedora:17""

_HOME\_URL=_, _DOCUMENTATION\_URL=_, _SUPPORT\_URL=_, _BUG\_REPORT\_URL=_, _PRIVACY\_POLICY\_URL=_
...
\m[blue]**RFC3986 format**\m[]\s-2\u[3]\d\s+2, and should be
"http:"
or
"https:"
URLs, and possibly
...
\m[blue]**freedesktop.org Icon Theme Specification**\m[]\s-2\u[4]\d\s+2. This can be used by graphical applications to display an operating systems or distributor\*(Aqs logo. This field is optional and may not necessarily be implemented on all systems. Examples:
"LOGO=fedora-logo",
...
_ID\_LIKE_
as fallback for
_ID_. When looking for an OS identification string for presentation to the user use the
_PRETTY\_NAME_
field.
