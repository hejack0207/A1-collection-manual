...
```
.HP \w'systemd-cgtop&nbsp;'u systemd-cgtop [OPTIONS...] [GROUP]
```
...
**top**(1). If a control group path is specified, shows only the services of the specified control group.
...
_CPUAccounting=1_,
_MemoryAccounting=1_
and
_BlockIOAccounting=1_
...
_MACHINE_. This option may not be used when a control group path is specified.
