...
state statistics. Either **command** is forked and
...
The executable **command** is forked and upon its exit, statistics gathered since it was
...
May work poorly on Linux-2.6.20 through 2.6.29, as the **acpi-cpufreq **
kernel frequency driver periodically cleared aperf/mperf registers in those
kernels.


<a name="nehalem-sandybridge-haswellextended"></a>
