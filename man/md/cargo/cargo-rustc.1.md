...
_environment variable_ &lt;https://doc.rust-lang.org/cargo/reference/environment-variables.html&gt; or the
**build.rustflags** _config value_ &lt;https://doc.rust-lang.org/cargo/reference/config.html&gt;.
...
**-p** _spec_, 
**--package** _spec_
The package to build. See **cargo-pkgid**(1) for the SPEC
format.
