...
<a name="edition-migration"></a>

### Edition migration

The **cargo fix** subcommand can also be used to migrate a package from one
_edition_ &lt;https://doc.rust-lang.org/edition-guide/editions/transitioning-an-existing-project-to-a-new-edition.html&gt; to the next. The general procedure is:

\h'-04' 1.\h'+01'Run **cargo fix --edition**. Consider also using the **--all-features** flag if
...
\h'-04' 2.\h'+01'Modify **Cargo.toml** to set the _edition field_ &lt;https://doc.rust-lang.org/cargo/reference/manifest.html#the-edition-field&gt; to the new edition.
