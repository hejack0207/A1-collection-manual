...
* The description of a
  _""_logon_""_
  key
  _muststart with a non-empty colon-delimited prefix whose purpose_
...
* Special keyrings  
  ...
  An example of this is the _system keyring_ used for holding
...
<a name="on-demand-key-creation"></a>
...
* _/proc/sys/kernel/keys/gc_delay_ (since Linux 2.6.32)  
...
* _/proc/sys/kernel/keys/persistent_keyring_expiry_ (since Linux 3.13)  
...
* _/proc/sys/kernel/keys/maxbytes_ (since Linux 2.6.26)  
...
* _/proc/sys/kernel/keys/maxkeys_ (since Linux 2.6.26)  
  
  
  This is the maximum number of keys that a nonroot user may own.
* The default value in this file is 200.
* _/proc/sys/kernel/keys/root_maxbytes_ (since Linux 2.6.26)  
...
* _/proc/sys/kernel/keys/root_maxkeys_ (since Linux 2.6.26)  
...
_Documentation/crypto/asymmetric-keys.txt_
and under
_Documentation/security/keys_
