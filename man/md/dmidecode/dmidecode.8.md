# dmidecode(8) - \s-1DMI\s0 table decoder

dmidecode, January 2019
...
* **-s**, **--string KEYWORD**  
  Only display the value of the \s-1DMI\s0 string identified by **KEYWORD**.
...
* **  **  **--no-sysfs**  
  ...
  debugging.
* **  **  **--oem-string N**  
  Only display the value of the \s-1OEM\s0 string number **N**. The first
...
_/dev/mem_  
_/sys/firmware/dmi/tables/smbios_entry_point_
(Linux only)  
_/sys/firmware/dmi/tables/DMI_
(Linux only)
