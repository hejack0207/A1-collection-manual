...
* **--bfreq** [_number_]  (virtual consoles only)  
...
* **--clrtabs** [_tab1 tab2 tab3_ ...]  (virtual consoles only)  
...
* **--term** _terminal\_name_  
  Overrides the TERM environment variable.
* **--ulcolor** _16-color_  (virtual consoles only)  
