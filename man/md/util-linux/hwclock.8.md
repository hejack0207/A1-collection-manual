...
* **--set**  
  ...
  **--set** fails.  See **--update-drift** below.
* **--systz**  
...
* **--adjfile=**_filename_  
  Override the default _/etc/adjtime_ file path.
* **--date=**_date_string_  
...
<a name="hardware-clock-access-methods"></a>
...
<a name="date-time-configuration"></a>

# Date-Time Configuration

.in +4

<a name="keeping-time-without-external-synchronization"></a>
...
* ·  
  ...
  **adjtimex&nbsp;--tick**_&nbsp;value&nbsp;_**--frequency**_&nbsp;value_  
  **hwclock&nbsp;--hctosys**
* ·  
...
* 2  
  The_ System Clock _time must be correct at shutdown!
* 3  
...
Written by Bryan Henderson, September 1996 ([bryanh@giraffe-data.com](mailto:bryanh@giraffe-data.com)),
