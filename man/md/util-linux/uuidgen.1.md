...
and
**--name** _name_.
The _namespace_ may either be a well-known UUID, or else
...
or
**@x500**.
The _name_ is an arbitrary string value.  The generated UUID is the
...
* **-n**,** --namespace **_namespace_  
  Generate the hash with the _namespace_ prefix. The _namespace_ is UUID,
