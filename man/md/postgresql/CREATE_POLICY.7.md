...
**ALTER TABLE ... ENABLE ROW LEVEL SECURITY**) in order for created policies to be applied.
...
**SELECT**), and will not be available for modification (in an
**UPDATE**
or
...
.nr an-break-flag 1  
**Table&nbsp;257.&nbsp;Policies Applied by Command Type**
.TS
allbox tab(:);
lB lB lB lB s lB
^ lB lB lB lB lB.
...
<a name="application-of-multiple-policies"></a>
...
ALTER POLICY (**ALTER\_POLICY**(7)), DROP POLICY (**DROP\_POLICY**(7)), ALTER TABLE (**ALTER\_TABLE**(7))
