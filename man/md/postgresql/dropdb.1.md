...
```
.HP \w'dropdb&nbsp;'u dropdb [connection-option...] [option...] dbname
```
...
SQL
command
DROP DATABASE (**DROP\_DATABASE**(7)). There is no effective difference between dropping databases via this utility and via other methods for accessing the server.
