...
.if n \{.RS 4
.\}
    CREATE USER davide WITH PASSWORD jw8s0F4*(Aq;
.if n \{.RE
.\}
...
.if n \{.RS 4
.\}
    CREATE ROLE miriam WITH LOGIN PASSWORD jw8s0F4*(Aq VALID UNTIL *(Aq2005-01-01*(Aq;
.if n \{.RE
.\}
...
SET ROLE (**SET\_ROLE**(7)), ALTER ROLE (**ALTER\_ROLE**(7)), DROP ROLE (**DROP\_ROLE**(7)), **GRANT**(7), **REVOKE**(7), **createuser**(1)
