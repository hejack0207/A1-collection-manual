...
**UPDATE**,
**FETCH**, or
**COPY**) of the transaction. Furthermore, the transaction must already be set to
SERIALIZABLE
or
REPEATABLE READ
...
**BEGIN**
or
**START TRANSACTION**. But that option is not available for
**SET TRANSACTION SNAPSHOT**.
...
.\}
    BEGIN TRANSACTION ISOLATION LEVEL REPEATABLE READ;
    SET TRANSACTION SNAPSHOT 00000003-0000001B-1*(Aq;
.if n \{.RE
.\}
