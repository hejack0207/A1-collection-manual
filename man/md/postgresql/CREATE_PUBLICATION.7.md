...
WITH ( _publication\_parameter_ [= _value_] [, ... ] )
...
insert, update, delete, truncate\*(Aq.
...
ALTER PUBLICATION (**ALTER\_PUBLICATION**(7)), DROP PUBLICATION (**DROP\_PUBLICATION**(7))
