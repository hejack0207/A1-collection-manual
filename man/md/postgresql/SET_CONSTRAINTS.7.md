...
and
CHECK
constraints are always checked immediately when a row is inserted or modified (_not_
...
“constraint triggers”
is also controlled by this setting — they fire at the same time that the associated constraint should be checked.
