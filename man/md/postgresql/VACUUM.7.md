...
**VACUUM**
is done. Therefore its necessary to do
**VACUUM**
...
**VACUUM**
may still block when opening the relations indexes. Additionally,
**VACUUM ANALYZE**
...
To vacuum a table, one must ordinarily be the tables owner or a superuser. However, database owners are allowed to vacuum all tables in their databases, except shared catalogs. (The restriction for shared catalogs means that a true database-wide
**VACUUM**
