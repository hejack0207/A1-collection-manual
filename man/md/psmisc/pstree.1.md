...
```
pstree [-a,&nbsp;--arguments] [-c,&nbsp;--compact] [-h,&nbsp;--highlight-all,&nbsp;-Hpid,&nbsp;--highlight-pid&nbsp;pid] [-g]&nbsp;--show-pgids] [-l,&nbsp;--long] [-n,&nbsp;--numeric-sort] [-N,&nbsp;--ns-sortns [-p,&nbsp;--show-pids] [-s,&nbsp;--show-parents] [-S,&nbsp;--ns-changes] [-t,&nbsp;--thread-names] [-T,&nbsp;--hide-threads] [-u,&nbsp;--uid-changes] [-Z,&nbsp;--security-context] [-A,&nbsp;--ascii,&nbsp;-G,&nbsp;--vt100,&nbsp;-U,&nbsp;--unicode] [pid,&nbsp;user]
pstree -V,&nbsp;--version
```
