...
```
 ...
 openat(): .RS 4 .TP 4 Since glibc 2.10: _POSIX_C_SOURCE&nbsp;>=&nbsp;200809L .TP Before glibc 2.10: _ATFILE_SOURCE .RE
```
...
* **O_NOFOLLOW**  
  If _pathname_ is a symbolic link, then the open fails, with the error
  **ELOOP**.
...
* **ENOTDIR**  
  ...
  _pathname_
  is not, in fact, a directory, or **O\_DIRECTORY** was specified and
  _pathname_
  was not a directory.
* **ENXIO**  
  **O_NONBLOCK** | **O_WRONLY**
...
<a name="open-file-descriptions"></a>
...
<a name="rationale-for-openat-and-other-directory-file-descriptor-apis"></a>
