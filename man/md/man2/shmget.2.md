...
* **IPC_CREAT**  
  ...
  **shmget**()
  will find the segment associated with _key_ and check to see if
...
* **EINVAL**  
  ...
  _key_
  exists, but _size_ is greater than the size
  of that segment.
* **ENFILE**  
  
  The system-wide limit on the total number of open files has been reached.
* **ENOENT**  
  No segment exists for the given _key_, and
  **IPC_CREAT**
  was not specified.
* **ENOMEM**  
