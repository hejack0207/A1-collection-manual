...
fmaps - print the process or a corefiles address maps
...
```
.HP \w'fmaps&nbsp;'u fmaps {program&nbsp;arg&nbsp;...  | pid... | core-file&nbsp;[&nbsp;core-executable&nbsp;]... }
```
...
**fmaps**
prints out a process or a corefiles address maps
