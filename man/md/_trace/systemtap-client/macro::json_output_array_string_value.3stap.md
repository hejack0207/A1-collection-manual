...
The json_output_array_string_value macro is designed to be called from the json_data\*(Aq probe in the user\*(Aqs script to output a metric\*(Aqs string value that is in an array. This metric should have been added with
