...
2) Returns the user time of the given task in cputime, or zero if the task doesnt exist. Does not include any time used by other tasks in this process, nor does it include any time of the children of this task.
