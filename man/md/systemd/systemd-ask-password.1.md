...
```
.HP \w'systemd-ask-password&nbsp;[OPTIONS...]&nbsp;[MESSAGE]&nbsp;'u systemd-ask-password [OPTIONS...] [MESSAGE]
```
...
\m[blue]**systemd Password Agent Specification**\m[]\s-2\u[1]\d\s+2.
...
\m[blue]**XDG Icon Naming Specification**\m[]\s-2\u[2]\d\s+2.
