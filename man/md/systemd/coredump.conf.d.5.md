...
**systemd-coredump**(8), a handler for core dumps invoked by the kernel. Whether
**systemd-coredump**
is used is determined by the kernels
_kernel.core\_pattern_&nbsp;**sysctl**(8)
setting. See
**systemd-coredump**(8)
and
**core**(5)
...
**systemd-tmpfiles**(8). Set either value to 0 to turn off size-based clean-up.
