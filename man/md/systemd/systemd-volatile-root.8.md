...
on the kernel command line. This service runs only in the initial RAM disk ("initrd"), before the system transitions to the hosts root directory. Note that this service is not used if
