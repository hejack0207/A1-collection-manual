...
<a name="socket-layer-functions"></a>
...
<a name="socket-address-structures"></a>
...
* **SO_RCVBUF**  
  ...
  **getsockopt**(2).
  ...
  _/proc/sys/net/core/rmem_default_
  file, and the maximum allowed value is set by the
  _/proc/sys/net/core/rmem_max_
  file.
...
* **SO_SNDBUF**  
  ...
  **getsockopt**(2).
  The default value is set by the
  _/proc/sys/net/core/wmem_default_
  file and the maximum allowed value is set by the
  _/proc/sys/net/core/wmem_max_
  file.
...
* **SO_BUSY_POLL** (since Linux 3.11)  
  ...
  **CAP_NET_ADMIN**.
  ...
  _/proc/sys/net/core/busy_read_
  file.
* The value in the
  _/proc/sys/net/core/busy_poll_
