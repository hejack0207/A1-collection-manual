...
* **PTRACE_KILL**  
  ...
  **SIGKILL**
  ...
  _data_
  are ignored.)
* _This operation is deprecated; do not use it!_
  Instead, send a
  **SIGKILL**
  directly using
  **kill**(2)
...
_signal-delivery-stop_,
_group-stop_,
_syscall-stop_,
_PTRACE_EVENT stops_,
and so on.
...
<a name="signal-injection-and-suppression"></a>
...
* _si_code_ == SI_KERNEL (0x80)  
  **SIGTRAP**
  was sent by the kernel.
* _si_code_ == SIGTRAP or _si_code_ == (SIGTRAP|0x80)  
...
<a name="ptrace_event_seccomp-stops-linux-35-to-47"></a>
...
<a name="ptrace_event_seccomp-stops-since-linux-48"></a>
...
<a name="ptrace_singlestep-stops"></a>
...
<a name="informational-and-restarting-ptrace-commands"></a>
...
<a name="attaching-and-detaching"></a>
...
and retain only one data structure—one which
...
<a name="ptrace-access-mode-checking"></a>
...
* 5.  
  The kernel LSM
  _security_ptrace_access_check_()
...
<a name="procsyskernelyamaptrace_scope"></a>
