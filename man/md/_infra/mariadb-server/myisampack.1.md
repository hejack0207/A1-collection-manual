...
```
.HP \w'myisampack&nbsp;[options]&nbsp;file_name&nbsp;...&nbsp;'u myisampack [options] file_name ...
```
...
_big\_tbl\_name_. All tables that are to be combined
_must_
...
.frm
file for
_big\_tbl\_name_, so after the join operation finishes, copy the
.frm
file from one of the source tables and name it
_big\_tbl\_name_.frm.
