...
<a name="check-options-check-is-the-default-action-for-aria_chk"></a>
...
<a name="recover-repair-options-when-using-recover-or-safe-recover"></a>
...
The following groups are read: **aria\_chk**
