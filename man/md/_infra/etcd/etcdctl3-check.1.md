...
etcdctl-check - commands for checking properties of the etcd cluster
...
```
 ...
 ETCDCTL=3 etcdctl check <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-check-datascale(1)**, **etcdctl3-check-perf(1)**
