...
etcdctl-user - User related commands
...
```
 ...
 ETCDCTL=3 etcdctl user <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-user-add(1)**, **etcdctl3-user-delete(1)**, **etcdctl3-user-get(1)**, **etcdctl3-user-grant-role(1)**, **etcdctl3-user-list(1)**, **etcdctl3-user-passwd(1)**, **etcdctl3-user-revoke-role(1)**
