...
etcdctl-del - Removes the specified key or range of keys [key, range\_end)
...
```
 ...
 ETCDCTL=3 etcdctl del [options] <key> [range\_end] [flags]
```
...
Removes the specified key or range of keys [key, range\_end)
