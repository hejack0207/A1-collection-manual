...
etcdctl-endpoint-health - Checks the healthiness of endpoints specified in **\fC--endpoints** flag
...
```
 ...
 ETCDCTL=3 etcdctl endpoint health [flags]
```
...
Checks the healthiness of endpoints specified in **\fC--endpoints** flag
