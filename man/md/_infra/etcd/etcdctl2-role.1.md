...
**etcdctl(1)**, **etcdctl-role-add(1)**, **etcdctl-role-delete(1)**, **etcdctl-role-get(1)**, **etcdctl-role-grant-permission(1)**, **etcdctl-role-list(1)**, **etcdctl-role-revoke-permission(1)**
