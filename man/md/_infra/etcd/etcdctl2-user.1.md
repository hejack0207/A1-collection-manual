...
**etcdctl(1)**, **etcdctl-user-add(1)**, **etcdctl-user-delete(1)**, **etcdctl-user-get(1)**, **etcdctl-user-grant-role(1)**, **etcdctl-user-list(1)**, **etcdctl-user-passwd(1)**, **etcdctl-user-revoke-role(1)**
