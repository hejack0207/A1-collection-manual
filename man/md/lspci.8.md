...
<a name="options-to-control-resolving-ids-to-names"></a>
...
<a name="options-for-selection-of-devices"></a>
...
* **-p &lt;file&gt;**  
  ...
  /lib/modules/_kernel_version_/modules.pcimap.
...
* **Slot**  
  ...
  ([_domain_:]_bus_:_device_._function_).
...
<a name="backward-compatible-verbose-format-vm"></a>
