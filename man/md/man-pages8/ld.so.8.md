...
**ld-linux.so***
(_/lib/ld-linux.so.1_ for libc5, _/lib/ld-linux.so.2_ for glibc2)
handles ELF,
...
<a name="rpath-token-expansion"></a>
...
<a name="secure-execution-mode"></a>
...
* The dynamic linker will notify the audit
  ...
  **rtld-audit**(7).
  ...
  in the chapter
  _Runtime Linker Auditing Interface_.
* Within the names specified in the
  **LD_AUDIT**
  list, the dynamic linker understands the tokens
  _$ORIGIN_,
...
* **LD_PROFILE** (since glibc 2.1)  
  ...
  "_$LD\_PROFILE\_OUTPUT_/_$LD\_PROFILE_.profile".
* Since glibc 2.2.5,
  **LD_PROFILE**
  is ignored in secure-execution mode.
