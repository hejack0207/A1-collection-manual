...
* **-4o6**_&nbsp;port_  
  ...
  to ::1 _port_ and _port + 1_. Both servers must
  be launched using the same _port_ argument.
* **-p**_&nbsp;port_  
...
_Modifying default file locations:_
...
**state _integer_ lookup, examine**
    1 = free
    2 = active
    3 = expired
    4 = released
...
**ip-address _data_ lookup, examine**
The IP address of the lease.

**dhcp-client-identifier _data_ lookup, examine, update**
The
...
**dhcp-client-identifier _data_ lookup, examine, modify**
the dhcp-client-identifier option that will be used to match the
client, if any.

**ip-address _data_ examine, modify**
...
**known _integer_ examine, modify**
if nonzero, indicates that a client matching this host declaration
will be treated as _known_ in pool permit lists.  If zero, the
...
**cur-unacked-updates _integer_ examine**
