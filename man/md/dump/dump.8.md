...
* **-a**  
  auto-size\*(rq. Bypass all tape length calculations, and write until an 
...
poses
_must_
be answered by typing yes\*(rq or \*(lqno\*(rq, appropriately.
