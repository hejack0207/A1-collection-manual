...
* **CAP_SYSLOG** (since Linux 2.6.37)  
    ...
    * *  
      ...
      _/proc/sys/kernel/kptr_restrict_
      has the value 1.
...
<a name="past-and-current-implementation"></a>
...
<a name="notes-to-kernel-developers"></a>
...
<a name="thread-capability-sets"></a>
...
_/proc/sys/kernel/cap_last_cap_
...
<a name="file-capability-mask-versioning"></a>
...
<a name="transformation-of-capabilities-during-execve"></a>
...
**execve**(2),
see below under
_Capabilities and execution of programs by root_.


<a name="safety-checking-for-capability-dumb-binaries"></a>
...
<a name="capabilities-and-execution-of-programs-by-root"></a>
...
<a name="set-user-id-root-programs-that-have-file-capabilities"></a>
...
<a name="capability-bounding-set"></a>
...
<a name="effect-of-user-id-changes-on-capabilities"></a>
...
<a name="programmatically-adjusting-capability-sets"></a>
...
<a name="the-securebits-flags-establishing-a-capabilities-only-environment"></a>
...
* **SECBIT_NO_SETUID_FIXUP**  
  ...
  (See the subsection
  _Effect of user ID changes on capabilities_.)
* **SECBIT_NOROOT**  
...
<a name="interaction-with-user-namespaces"></a>
...
<a name="namespaced-file-capabilities"></a>
...
_File capability mask versioning_,
above.
