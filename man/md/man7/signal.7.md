...
<a name="waiting-for-a-signal-to-be-caught"></a>
...
<a name="synchronously-accepting-a-signal"></a>
...
<a name="signal-mask-and-pending-signals"></a>
...
programs should
_never refer to real-time signals using hard-coded numbers_,
...
**sigaction**(2)	**rt\_sigaction**(2)
**sigpending**(2)	**rt\_sigpending**(2)
**sigprocmask**(2)	**rt\_sigprocmask**(2)
**sigreturn**(2)	**rt\_sigreturn**(2)
**sigsuspend**(2)	**rt\_sigsuspend**(2)
**sigtimedwait**(2)	**rt\_sigtimedwait**(2)
.TE


<a name="interruption-of-system-calls-and-library-functions-by-signal-handlers"></a>
...
<a name="interruption-of-system-calls-and-library-functions-by-stop-signals"></a>
