...
<a name="strace1-seccomp2-and-the-vdso"></a>
...
_Documentation/arm/kernel_user_helpers.txt_.

<a name="aarch64-functions"></a>
...
<a name="bfin-blackfin-functions"></a>
...
<a name="ia64-itanium-functions"></a>
...
<a name="parisc-hppa-functions"></a>
...
_not_
supported by the
___kernel_clock_getres_
and
___kernel_clock_gettime_
interfaces;
the kernel falls back to the real system call.

<a name="ppc64-functions"></a>
