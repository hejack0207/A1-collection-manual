...
<a name="level-triggered-and-edge-triggered"></a>
...
<a name="interaction-with-autosleep"></a>
...
* _/proc/sys/fs/epoll/max_user_watches_ (since Linux 2.6.28)  
...
<a name="example-for-suggested-usage"></a>
...
<a name="possible-pitfalls-and-ways-to-avoid-them"></a>
