# nfs(5) - fstab format and options for the
...
<a name="options-supported-by-all-versions"></a>
...
<a name="options-for-nfs-versions-2-and-3-only"></a>
...
<a name="options-for-nfs-version-4-only"></a>
...
* **clientaddr=**_n.n.n.n_  
* **clientaddr=**_n:n:_**...**_:n_  
...
<a name="using-the-mountproto-mount-option"></a>
...
<a name="using-nfs-over-udp-on-high-speed-links"></a>
...
<a name="close-to-open-cache-consistency"></a>
...
is referred to as
_close-to-open cache consistency_,
or
_CTO_.
...
<a name="weak-cache-consistency"></a>
...
<a name="file-timestamp-maintainence"></a>
...
<a name="directory-entry-caching"></a>
...
_positive_lookup_result._
If the requested directory entry does not exist on the server
(that is, the server returned ENOENT),
the result is referred to as
_negative_lookup_result._
...
<a name="the-sync-mount-option"></a>
...
<a name="using-file-locks-with-nfs"></a>
...
<a name="nfs-version-4-caching-features"></a>
...
<a name="nfs-version-4-filesystem-crossing"></a>
...
<a name="using-non-privileged-source-ports"></a>
...
<a name="mounting-through-a-firewall"></a>
...
<a name="nfs-access-control-lists"></a>
...
<a name="unmounting-after-a-remount"></a>
