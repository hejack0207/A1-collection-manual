...
```
xfs_repair [ -dfLPv ] [ -n | -e ] [ -m maxmem ] [ -c subopt=value ] [ -o subopt\c [\c =\c value] ] [ -t interval ] [ -l logdev ] [ -r rtdev ] device
xfs_repair -V
```
...
* The
  ...
  supported are:
    * **bhash=**_bhashsize_  
      ...
      RAM size.
    * **ag_stride=**_ags_per_concat_unit_  
...
<a name="corrupted-superblocks"></a>
...
**imap claims free inode**
_ino_
**is in use, correcting imap**
...
**in dir**
_dir_ino_
**references already connected dir ino**
_ino_**,**
**junking entry**
_name_
**in directory inode**
