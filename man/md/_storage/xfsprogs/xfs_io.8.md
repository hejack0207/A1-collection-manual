...
* **pread [ -b **_bsize_** ] [ -qv ] [ -FBR [ -Z **_seed_** ] ] [ -V **_vectors_** ] **_offset length_  
...
* **r**  
  ...
  **pread**
  command.
* **pwrite [ -i **_file_** ] [ -qdDwNOW ] [ -s **_skip_** ] [ -b **_size_** ] [ -S **_seed_** ] [ -FBR [ -Z **_zeed_** ] ] [ -V **_vectors_** ] **_offset length_  
...
* **freesp **_size_** 0**  
  ...
  **allocsp**
  command.
* **fadvise [ -r | -s | [[ -d | -n | -w ] **_offset length _**]]**  
...
* **truncate**_ offset_  
  ...
  **ftruncate**(2).
* **sendfile [ -q ] -i **_srcfile_** | -f **_N_** [ **_offset length _**]**  
...
* **dedupe  [ -C ] [ -q ] src_file src_offset dst_offset length**  
  ...
  **BTRFS_IOC_FILE_EXTENT_SAME**
  ...
  on write") in the affected file, leaving the other file(s) unchanged.
    ...
    * **-q**  
      Do not print timing statistics at all.
* **copy_range [ -s **_src_offset_** ] [ -d **_dst_offset_** ] [ -l **_length_** ] src_file | -f **_N_  
  On filesystems that support the
  **copy_file_range**(2)
...
* **swapext**_ donor_file _  
  ...
  with the fork(s)).
* **set_encpolicy [ -c **_mode_** ] [ -n **_mode_** ] [ -f **_flags_** ] [ -v **_version_** ] [ **_keyspec_** ]**  
...
* **add_enckey [ -d **_descriptor_** ] [ -k **_key_id_** ]**  
...
* **utimes**_ atime_sec atime_nsec mtime_sec mtime_nsec_  
...
<a name="memory-mapped-io-commands"></a>

# Memory Mapped I/O Commands


* **mmap [ **_N_** | [[ -rwxS ] [-s **_size_** ] **_offset length _**]]**  
  With no arguments,
  **mmap**
...
* **mm**  
  ...
  **mmap**
  command.
* **mremap [ -f &lt;new_address&gt; ] [ -m ] **_new_length_  
...
* **mr**  
  ...
  **mread**
  command.
* **mwrite [ -r ] [ -S **_seed_** ] [ **_offset length _**]**  
...
* **ms**  
  ...
  **msync**
  command.
* **madvise [ -d | -r | -s | -w ] [ **_offset length _**]**  
