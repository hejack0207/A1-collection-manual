...
LVM TOOLS 2.02.183(2) (2018-12-07), 8
...
complete **lvconvert**(8) and **pvmove**(8) operations. lvpoll itself
...
**lvm lvpoll** **--polloperation** **pvmove**|**convert**|**merge**|**merge\_thin** _LV_ ...  
[ **-A**|**--autobackup** **y**|**n** ]  
[ **-i**|**--interval** _Number_ ]  
[    **--abort** ]  
[    **--handlemissingpvs** ]  
...
.HP
**--polloperation** **pvmove**|**convert**|**merge**|**merge\_thin**  
