...
If the configuration setting **metadata/record\_lvs\_history** is enabled
...
retained. This includes the time of removal (**lv\_time\_removed**
reporting field), creation time (**lv\_time**), name (**lv\_name**), LV
uuid (**lv\_uuid**) and VG name (**vg\_name**). This allows later
