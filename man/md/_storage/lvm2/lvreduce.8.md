...
**lvconvert**(8) to change the number of data images in a RAID or
mirrored LV.

Be careful when reducing an LV's size, because data in the reduced area is
lost. Ensure that any file system on the LV is resized **before**
...
**lvreduce** **-L**|**--size** [**-**]_Size_[m|UNIT] _LV_  
