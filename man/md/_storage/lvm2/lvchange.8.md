...
**lvchange** **--resync** _VG_|_LV__\_mirror\_raid_|_Tag_|_Select_ ...  
[ **-a**|**--activate** **y**|**n**|**ay** ]  
[ COMMON_OPTIONS ]  
-
...
**lvchange** **--syncaction** **check**|**repair** _VG_|_LV__\_raid_|_Tag_|_Select_ ...  
[ COMMON_OPTIONS ]  
-

Reconstruct data on specific PVs of a raid LV.  

**lvchange** **--rebuild** _PV_ _VG_|_LV__\_raid_|_Tag_|_Select_ ...  
[ COMMON_OPTIONS ]  
-
...
**y** makes LVs active, or available.
**n** makes LVs inactive, or unavailable.
...
**ay** specifies autoactivation, in which case an LV is activated
...
See **lvmlockd**(8) for more information about activation options **ey** and **sy** for shared VGs.
See **clvmd**(8) for more information about activation options **ey**, **sy**, **ly** and **ln** for clustered VGs.
.HP
**--activationmode** **partial**|**degraded**|**complete**  
...
**check** will count but not correct discrepancies.
**repair** will correct discrepancies.
...
the suffix **:t**. Repeat this option to change the attribute on
multiple PVs.
.HP
**-y**|**--yes**  
