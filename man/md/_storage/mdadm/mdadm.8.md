  ...
  **mdadm.conf**.
  ...
  Options are:
    ...
    * 1, 1.0, 1.1, 1.2 default  
      ...
      'if '1.2'1.2'  "default" is equivalent to "1.2".
    * ddf  
...
* **--homehost=**  
  ...
  **Auto Assembly**.
  ...
  is created with
  **--homehost=any**
  then the name "**any**" will be stored in the array and it can be
...
* **--detail-platform**  
  ...
  _/sys/devices/pci0000:00/0000:00:1f.2_.
...
Usage:
**mdadm --assemble**
_md-device options-and-component-devices..._
.HP 12
Usage:
**mdadm --assemble --scan**
_md-devices-and-options..._
.HP 12
Usage:
**mdadm --assemble --scan**
_options..._
...
<a name="chunk-size-and-layout-changes"></a>
...
<a name="consistency-policy-changes"></a>
...
[**--quiet**]
_component-device_
[_optional-aliases-for-device_]
.HP 12
Usage:
**mdadm --incremental --fail**
_component-device_
.HP 12
Usage:
...
be partitioned.  So the "md\_d**NN**"
names are no longer needed, and
partitions such as "/dev/md**NN**p**XX**"
are possible.
