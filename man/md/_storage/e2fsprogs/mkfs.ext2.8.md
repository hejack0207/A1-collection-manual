...
<synopsis>
[ -L volume-label ] [ -n ] [ -q ] [ -v ] external-journal [ fs-size ]
```
  ...
  **-R**
  ...
  The following extended options are supported:
    * **encoding=**_encoding-name_  
      ...
      **mke2fs.conf**(5)
      is used.
    * **encoding_flags=**_encoding-flags_  
      ...
      _strict_
      flag is disabled.
    * **mmp_update_interval=**_interval_  
    ...
    * **resize=**_max-online-resize_  
      ...
      _max-online-resize_
      blocks.
    * **lazy\_itable\_init[**= &lt;0 to disable, 1 to enable&gt;**]**  
    ...
    * **lazy\_journal\_init[**= &lt;0 to disable, 1 to enable&gt;**]**  
    ...
    * **packed\_meta\_blocks[**= &lt;0 to disable, 1 to enable&gt;**]**  
    ...
    * **root_owner**_[=uid:gid]_  
      ...
      The **root\_owner=** option allows explicitly specifying these values,
...
* **-l**_ filename_  
  ...
  **badblocks**
  program.
* **-L**_ new-volume-label_  
  Set the volume label for the filesystem to
  _new-volume-label_.
  The maximum length of the
  volume label is 16 bytes.
* **-m**_ reserved-blocks-percentage_  
...
* **-z**_ undo_file_  
  ...
  mke2fs-_device_.e2undo in the directory specified via the
  _E2FSPROGS\_UNDO\_DIR_ environment variable or the _undo\_dir_ directive
...
This version of
**mke2fs**
has been written by Theodore Ts'o &lt;[tytso@mit.edu](mailto:tytso@mit.edu)&gt;.
