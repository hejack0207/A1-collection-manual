...
specifier: "**LABEL=volume-label**" or "**UUID=uuid**".  (i.e.,
...
* **-i  _interval-between-checks_[**d**|**m**|**w**]**  
  Adjust the maximal time between two filesystem checks.
  No suffix or
  **d**
  will interpret the number
  _interval-between-checks_
  as days,
  **m**
  as months, and
  **w**
...
* **-z**_ undo_file_  
  ...
  tune2fs-_device_.e2undo in the directory specified via the
...
**tune2fs**
uses the ext2fs library written by Theodore Ts'o &lt;[tytso@mit.edu](mailto:tytso@mit.edu)&gt;.
This manual page was written by Christian Kuhtz &lt;[chk@data-hh.Hanse](mailto:chk@data-hh.Hanse).DE&gt;.
Time-dependent checking was added by Uwe Ohse &lt;[uwe@tirka.gun](mailto:uwe@tirka.gun).de&gt;.
