...
Scyld Beowulf\[tm], September 9, 2003
...
This **mii-diag** command configures, controls and monitors the
transceiver management registers for network interfaces, and configures
driver operational parameters.  For transceiver control **mii-diag**
