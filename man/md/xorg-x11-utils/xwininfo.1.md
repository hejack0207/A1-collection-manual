...
There is also a special **-root** option to quickly obtain information
...
* **-id _id_**  
  This option allows the user to specify a target window _id_ on the
...
* **-name _name_**  
  This option allows the user to specify that the window named _name_
...
* **-english**  
  ...
  number of pixels. **-metric** and **-english** may both be enabled at the
  same time.
...
* **-display _display_**  
  This option allows you to specify the server to connect to; see _X(7)_.
  PP
* **-version**  
