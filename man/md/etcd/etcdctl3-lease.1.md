...
etcdctl-lease - Lease related commands
...
```
 ...
 ETCDCTL=3 etcdctl lease <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-lease-grant(1)**, **etcdctl3-lease-keep-alive(1)**, **etcdctl3-lease-list(1)**, **etcdctl3-lease-revoke(1)**, **etcdctl3-lease-timetolive(1)**
