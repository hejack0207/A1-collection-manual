...
etcdctl-endpoint - Endpoint related commands
...
```
 ...
 ETCDCTL=3 etcdctl endpoint <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-endpoint-hashkv(1)**, **etcdctl3-endpoint-health(1)**, **etcdctl3-endpoint-status(1)**
