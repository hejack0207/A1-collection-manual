...
etcdctl-snapshot - Manages etcd node snapshots
...
```
 ...
 ETCDCTL=3 etcdctl snapshot <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-snapshot-restore(1)**, **etcdctl3-snapshot-save(1)**, **etcdctl3-snapshot-status(1)**
