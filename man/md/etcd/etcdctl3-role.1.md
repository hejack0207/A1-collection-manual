...
etcdctl-role - Role related commands
...
```
 ...
 ETCDCTL=3 etcdctl role <subcommand> [flags]
```
...
**etcdctl(1)**, **etcdctl3-role-add(1)**, **etcdctl3-role-delete(1)**, **etcdctl3-role-get(1)**, **etcdctl3-role-grant-permission(1)**, **etcdctl3-role-list(1)**, **etcdctl3-role-revoke-permission(1)**
