...
<a name="io-on-pipes-and-fifos"></a>
...
_pipe-user-pages-soft_
and
_pipe-user-pages-hard_
limits; see BUGS.
...
* **O\_NONBLOCK** disabled, _n_ &lt;= **PIPE\_BUF**  
  All
  _n_
...
* **O\_NONBLOCK** enabled, _n_ &lt;= **PIPE\_BUF**  
...
<a name="open-file-status-flags"></a>
