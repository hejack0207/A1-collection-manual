...
<a name="reading-events-from-an-inotify-file-descriptor"></a>
...
_inotify_event_
structure is thus
_sizeof(struct inotify_event)+len_.
...
<a name="dealing-with-rename-events"></a>
...
_Documentation/filesystems/inotify.txt_
