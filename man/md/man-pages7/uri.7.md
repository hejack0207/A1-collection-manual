...
.HP
_ip_server = _[_user_ [ : _password_ ] @ ] _host_ [ : _port_]
...
http://_ip_server_/_path_  
http://_ip_server_/_path_?_query_
...
gopher://_ip_server_/_gophertype selector_  
gopher://_ip_server_/_gophertype selector_%09_search_  
gopher://_ip_server_/_gophertype selector_%09_search_%09_gopher+_string_  
...
[IETF RFC&nbsp;1036,](http://www.ietf.org​/rfc​/rfc1036.txt)
without the enclosing "&lt;"
and "&gt;"; it takes the form
_unique_@_full_domain_name_.
...
file://_ip_server_/_path_segments_  
file:_path_segments_
...
(see
[IETF RFC&nbsp;1625](http://www.ietf.org​/rfc​/rfc1625.txt)
...
HTML uses the format &lt;A HREF="_uri_"&gt;
_text_
&lt;/A&gt;.
Texinfo files use the format @uref{_uri_}.
