...
**aio\_error**(3)
**aio\_return**(3)
**aio\_suspend**(3)	See notes below
**alarm**(2)
**bind**(2)
**cfgetispeed**(3)
**cfgetospeed**(3)
...
**pselect**(2)
**pthread\_kill**(3)	Added in POSIX.1-2013
**pthread\_self**(3)	Added in POSIX.1-2013
**pthread\_sigmask**(3)	Added in POSIX.1-2013
**raise**(3)
**read**(2)
**readlink**(2)
...
**strtok\_r**(3)	Added in POSIX.1-2016
**symlink**(2)
...
<a name="deviations-in-the-gnu-c-library"></a>
