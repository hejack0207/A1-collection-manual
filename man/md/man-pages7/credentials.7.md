...
<a name="parent-process-id-ppid"></a>
...
<a name="process-group-id-and-session-id"></a>
...
_process group leader_ for that group.
...
**setsid**(2).
The creator of the session is called the _session leader_.

All of the processes in a session share a
_controlling terminal_.
...
<a name="user-and-group-identifiers"></a>
