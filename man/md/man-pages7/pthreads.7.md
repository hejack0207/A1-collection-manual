...
<a name="pthreads-function-return-values"></a>
...
<a name="thread-safe-functions"></a>
...
<a name="async-cancel-safe-functions"></a>
...
<a name="linux-implementations-of-posix-threads"></a>
...
<a name="determining-the-threading-implementation"></a>
...
<a name="selecting-the-threading-implementation-ld_assume_kernel"></a>

### Selecting the threading implementation: LD_ASSUME_KERNEL

On systems with a glibc that supports both LinuxThreads and NPTL
(i.e., glibc 2.3._x_), the
**LD_ASSUME_KERNEL**
...
.in +4n
.EX
bash$ $( LD_ASSUME_KERNEL=2.2.5 ldd /bin/ls | grep libc.so | &nbsp;               awk '{print $3}' ) | egrep -i 'threads|nptl'
