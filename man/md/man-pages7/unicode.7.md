...
<a name="combining-characters"></a>

### Combining characters

Some code points in UCS
have been assigned to
_combining characters_.
...
<a name="implementation-levels"></a>

### Implementation levels

As not all systems are expected to support advanced mechanisms like
combining characters, ISO 10646-1 specifies the following three
_implementation levels_
of UCS:
...
<a name="private-use-areas-pua"></a>
...
itself is
_Documentation/admin-guide/unicode.rst_
in the Linux kernel sources

(or
_Documentation/unicode.txt_
before Linux 4.10).
