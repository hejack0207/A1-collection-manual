...
when writing man pages for the Linux _man-pages_ project,
...
<a name="sections-of-the-manual-pages"></a>
...
<a name="conventions-for-source-file-layout"></a>
...
* For those few _man-pages_ pages in Sections 1 and 8,
...
* _manual_  
  ...
  the _man-pages_ package, use
  _Linux Programmer's Manual_).

<a name="sections-within-a-manual-page"></a>
...
_Where a traditional heading would apply_, _please use it_;
...
traditional headings, with some subsections (_.SS_) within
those sections.
...
* For Section 2 and 3 man pages you may find it useful to include
  subsections (**SS**) named _Linux Notes_ and _Glibc Notes_.
* In Section 2, use the heading
  _C library/kernel differences_
...
<a name="use-of-gender-neutral-language"></a>
...
<a name="formatting-conventions-for-manual-pages-describing-commands"></a>
...
_even in the SYNOPSIS section_.

The name of the command, and its options, should
always be formatted in bold.


<a name="formatting-conventions-for-manual-pages-describing-functions"></a>
...
(Using this format, rather than the use of "...\**()"
makes it easier to write tools that parse man page source files.)


<a name="formatting-conventions-general"></a>
...
<a name="indentation-of-structure-definitions-shell-session-logs-and-so-on"></a>
...
_Hyphenation of attributive compounds_
below.

<a name="terms-to-avoid"></a>
...
<a name="null-nul-null-pointer-and-null-character"></a>
...
<a name="use-of-eg-ie-etc-aka-and-similar"></a>
...
at either end of this subphrase—in *roff is with the macro "\—".
...
<a name="hyphenation-of-attributive-compounds"></a>
...
<a name="hyphenation-with-multi-non-pre-re-sub-and-so-on"></a>
...
<a name="example-programs-and-shell-sessions"></a>
