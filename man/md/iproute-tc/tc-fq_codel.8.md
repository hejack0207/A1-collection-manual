# fq_codel(8) - Fair Queuing (FQ) with Controlled Delay (CoDel)

iproute2, 4 June 2012
...
mailing list &lt;[netdev@vger.kernel](mailto:netdev@vger.kernel).org&gt;.
