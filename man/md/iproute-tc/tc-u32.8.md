# universal 32bit classifier in tc(8) - universal 32bit traffic control filter

iproute2, 25 Sep 2015

```
.in +8 .ti -8 tc filter ... [ handle HANDLE ]  u32 OPTION_LIST [  offset OFFSET ] [  hashkey HASHKEY ] [  classid CLASSID ] [  divisor uint_value ] [  order u32_value ] [  ht HANDLE ] [  sample SELECTOR [  divisor uint_value ] ] [  link HANDLE ] [  indev ifname ] [  skip_hw |  skip_sw ] [  help ]
</synopsis>

<synopsis>
.ti -8 HANDLE := {  u12_hex_htid:[u8_hex_hash:[u12_hex_nodeid] | 0xu32_hex_value }
</synopsis>

<synopsis>
.ti -8 OPTION_LIST := [ OPTION_LIST ] OPTION
</synopsis>

<synopsis>
.ti -8 HASHKEY := [  mask u32_hex_value ] [  at 4*int_value ]
</synopsis>

<synopsis>
.ti -8 CLASSID := {  root |  none |  [u16_major]:u16_minor | u32_hex_value }
</synopsis>

<synopsis>
.ti -8 OFFSET := [  plus int_value ] [  at 2*int_value ] [  mask u16_hex_value ] [  shift int_value ] [  eat ]
</synopsis>

<synopsis>
.ti -8 OPTION := {  match SELECTOR |  action ACTION } 
</synopsis>

<synopsis>
.ti -8 SELECTOR := {  u32 VAL_MASK_32 |  u16 VAL_MASK_16 |  u8 VAL_MASK_8 |  ip IP |  ip6 IP6 | {  tcp | udp }  TCPUDP |  icmp ICMP |  mark VAL_MASK_32 |  ether ETHER }
</synopsis>

<synopsis>
.ti -8 IP := { {  src | dst } { default | any | all |  ip_address [  / {  prefixlen | netmask } ] } AT | {  dsfield | ihl | protocol | precedence |  icmp_type | icmp_code }  VAL_MASK_8 | {  sport | dport }  VAL_MASK_16 |  nofrag | firstfrag | df | mf }
</synopsis>

<synopsis>
.ti -8 IP6 := { {  src | dst } { default | any | all |  ip6_address [/prefixlen ] } AT |  priority VAL_MASK_8 | {  protocol | icmp_type | icmp_code }  VAL_MASK_8 |  flowlabel VAL_MASK_32 | {  sport | dport }  VAL_MASK_16 }
</synopsis>

<synopsis>
.ti -8 TCPUDP := {  src | dst }  VAL_MASK_16
</synopsis>

<synopsis>
.ti -8 ICMP := {  type VAL_MASK_8 |  code VAL_MASK_8 }
</synopsis>

<synopsis>
.ti -8 ETHER := {  src | dst }  ether_address AT
</synopsis>

<synopsis>
.ti -8 VAL_MASK_32 := u32_value u32_hex_mask [ AT ]
</synopsis>

<synopsis>
.ti -8 VAL_MASK_16 := u16_value u16_hex_mask [ AT ]
</synopsis>

<synopsis>
.ti -8 VAL_MASK_8 := u8_value u8_hex_mask [ AT ]
</synopsis>

<synopsis>
.ti -8 AT := [  at [ nexthdr+ ]  int_value ]
```
...
* **offset**_ OFFSET_  
  ...
  **link** or a combination of **ht** and **sample**.
...
* **link**_ HANDLE_  
  ...
  **htid** may be given, **hash** and **nodeid**
...
* **ip**_ IP_  
  ...
  **ip6**)
  ...
  then allows to match various header fields:
    ...
    * **sport**_ VAL_MASK_16_  
      .TQ
      **dport**_ VAL_MASK_16_
...
* **ether**_ ETHER_  
  ...
  _ETHER_
  are:
    * **src**_ ether_address_** **_AT_  
      .TQ
      **dst**_ ether_address_** **_AT_
...
filter parent 1: protocol ip pref 99 u32 &nbsp;       fh 800: ht divisor 1
filter parent 1: protocol ip pref 99 u32 &nbsp;       fh 800::800 order 2048 key ht 800 bkt 0 flowid 1:1 &nbsp;       match c0a80800/ffffff00 at 12
.EE
...
tc filter add dev eth0 parent 1:0 protocol ip &nbsp;       u32 ht 1: &nbsp;       match tcp src 22 FFFF &nbsp;       classid 1:2
tc filter add dev eth0 parent 1:0 protocol ip &nbsp;       u32 ht 800: &nbsp;       match ip protocol 6 FF &nbsp;       match ip firstfrag &nbsp;       offset at 0 mask 0f00 shift 6 &nbsp;       link 1:
.EE
