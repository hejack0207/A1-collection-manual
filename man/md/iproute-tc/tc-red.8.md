...
iproute2, 13 December 2001

```
tc qdisc ... red limit bytes [ min bytes ] [ max bytes ] avpkt bytes [ burst packets ] [ ecn ] [ harddrop ] [ nodrop ] [ bandwidth rate ] [ probability chance ] [ adaptive ]
```
...
Alexey N. Kuznetsov, &lt;[kuznet@ms2.inr](mailto:kuznet@ms2.inr).ac.ru&gt;,  Alexey Makarenko
&lt;[makar@phoenix.kharkov](mailto:makar@phoenix.kharkov).ua&gt;, J Hadi Salim &lt;hadi@nortelnetworks.com&gt;,
Eric Dumazet &lt;[eric.dumazet@gmail.com](mailto:eric.dumazet@gmail.com)&gt;.
