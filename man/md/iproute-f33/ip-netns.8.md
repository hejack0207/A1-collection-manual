...
iproute2, 16 Jan 2013

```

 .in +8 .ti -8 ip [ OPTIONS ] netns  { COMMAND |  help } 
 .ti -8 ip netns [ list ]
</synopsis>

<synopsis>
.ti -8 ip netns add NETNSNAME
</synopsis>

<synopsis>
.ti -8 ip netns attach NETNSNAME PID
</synopsis>

<synopsis>
.ti -8 ip [-all] netns del [ NETNSNAME ]
</synopsis>

<synopsis>
.ti -8 ip netns set NETNSNAME NETNSID
</synopsis>

<synopsis>
.ti -8 NETNSID := auto | POSITIVE-INT
</synopsis>

<synopsis>
.ti -8 ip netns identify [ PID ]
</synopsis>

<synopsis>
.ti -8 ip netns pids NETNSNAME
</synopsis>

<synopsis>
.ti -8 ip [-all] netns exec  [ NETNSNAME ] command...
</synopsis>

<synopsis>
.ti -8 ip netns monitor
</synopsis>

<synopsis>
.ti -8 ip netns list-id [ target-nsid POSITIVE-INT ] [ nsid POSITIVE-INT ]
```
