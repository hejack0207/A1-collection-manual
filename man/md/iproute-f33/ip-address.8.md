...
```
 ...
 .in +8 .ti -8 ip [ OPTIONS ] address  { COMMAND |  help } 

</synopsis>

<synopsis>
.ti -8 ip address { add | change | replace }  IFADDR dev IFNAME [ LIFETIME ] [ CONFFLAG-LIST ]
</synopsis>

<synopsis>
.ti -8 ip address del IFADDR dev IFNAME [ mngtmpaddr ]
</synopsis>

<synopsis>
.ti -8 ip address { save | flush } [ dev IFNAME ] [   scope SCOPE-ID ] [   metric METRIC ] [   to PREFIX ] [ FLAG-LIST ] [   label PATTERN ] [ up ]
</synopsis>

<synopsis>
.ti -8 ip address [ show [ dev IFNAME ] [   scope SCOPE-ID ] [   to PREFIX ] [ FLAG-LIST ] [   label PATTERN ] [   master DEVICE ] [   type TYPE ] [  vrf NAME ] [  up ] ]
</synopsis>

<synopsis>
.ti -8 ip address { showdump | restore }
</synopsis>

<synopsis>
.ti -8 IFADDR := PREFIX | ADDR  peer PREFIX [   broadcast ADDR ] [   anycast ADDR ] [   label LABEL ] [   scope SCOPE-ID ]
</synopsis>

<synopsis>
.ti -8 SCOPE-ID :=  [ host | link | global |  NUMBER ]
</synopsis>
...
<synopsis>
.ti -8 FLAG := [ [-]permanent | [-]dynamic | [-]secondary | [-]primary | [-]tentative | [-]deprecated | [-]dadfailed | [-]temporary | CONFFLAG-LIST ]
</synopsis>

<synopsis>
.ti -8 CONFFLAG-LIST := [ CONFFLAG-LIST ] CONFFLAG
</synopsis>

<synopsis>
.ti -8 CONFFLAG :=  [ home | mngtmpaddr | nodad | optimstic | noprefixroute | autojoin ]
</synopsis>

<synopsis>
.ti -8 LIFETIME := [  valid_lft LFT ] [ preferred_lft LFT ]
</synopsis>

<synopsis>
.ti -8 LFT := [  forever | SECONDS ]
</synopsis>

<synopsis>
.ti -8 TYPE := [  bridge |  bridge_slave | bond |  bond_slave | can |  dummy |  hsr |  ifb |  ipoib | macvlan |  macvtap |  vcan |  veth |  vlan |  vxlan | ip6tnl | ipip | sit | gre | gretap | erspan | ip6gre | ip6gretap | ip6erspan | vti | vrf | nlmon | ipvlan | lowpan | geneve | macsec ]
```
...
<a name="ip-address-add-add-new-protocol-address"></a>
...
* **mngtmpaddr**  
  ...
  the **use\_tempaddr** sysctl setting has to be set to a value greater than
...
<a name="ip-address-delete-delete-protocol-address"></a>
...
<a name="ip-address-show-look-at-protocol-addresses"></a>

### ip address show - look at protocol addresses



* **dev**_ IFNAME _**(default)**  
  name of device.
...
<a name="ip-address-flush-flush-protocol-addresses"></a>
