...
```
    at [(mim] [(mif file] [(miq queuename] (mit time_arg
    
    at [(mim] [(mif file] [(miq queuename] timespec...
    
    at (mir at_job_id...
    
    at (mil (miq queuename
...
* _time_  
  ...
  &lt;colon&gt;,
  meaning _hour_:_minute_. An AM/PM indication (one of the values
  from the
  **am_pm**
  keywords in the
  _LC_TIME_
  ...
  **utc**
  ...
  field can also be one of the following tokens:
    ...
    * **now**  
      ...
      _at_
      &lt;**now**&gt; shall submit an at-job for potentially immediate execution
...
The behavior of
_at_
&lt;**now**&gt; was changed in an early proposal from being unspecified to
