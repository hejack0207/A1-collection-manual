...
* ·  
  **zap** - the dvb-apps legacy format for tuning, with supports only
...
* ·  
  **vdr** - the format used by the vdr application. It supports all features
...
* **-I**, **--input-format**=_format_  
  ...
  Supported input formats: **channel\f, zap** and **dvbv5**.
* **-O**, **--output-format**=_format_  
  Format of the output file.
  Supported output formats: **vdr**, **channel**, **zap** and **dvbv5**.
* **-s**, **--delsys**=_system_  
...
<a name="converting-a-channel-file-from-legacy-dvb-apps-format"></a>
...
<a name="convert-a-dvbv5-file-with-programs-on-it-to-the-legacy-dvb-apps-zap-format"></a>
