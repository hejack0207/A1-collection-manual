...
* **-d**, **--set-delsys**=_PARAMS_  
  Sets delivery system to the one specified at _PARAMS_. use _help_ to
...
<a name="showing-device-capabilities"></a>
...
<a name="setting-the-delivery-system"></a>
...
<a name="getting-the-current-frontend-settings"></a>
...
<a name="monitoring-the-frontend"></a>
...
an audio when BELL (_character_) is sent to the terminal.
