...
While **$GIT\_DIR/info/sparse-checkout** is usually used to specify what files are in, you can also specify what files are _not_ in, using negate patterns. For example, to remove the file **unwanted**:
