...
--numstat
Similar to
**--stat**, but shows the number of added and deleted lines in decimal notation and the pathname without abbreviation, to make it more machine friendly. For binary files, outputs two
**-**
instead of saying
**0 0**. Turns off "apply".
...
**--intent-to-add**
option in
**git-add**(1)). This option is ignored unless running in a Git repository and
**--index**
