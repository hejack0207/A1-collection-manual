...
**https://example.com/foo.git**, we might generate the following credential description (don’t forget the blank line at the end; it tells
**git credential**
