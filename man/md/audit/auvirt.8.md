...
**--stdin** and **--file** options can be specified to change this
behavior.
...
* **-f**, **--file** _file_  
  Read records from the given _file_ instead from the system audit log file.
* **-h**, **--help**  
...
* **--stdin**  
  ...
  This option cannot be specified with **--file**. The audit events must be in the raw format.
* **--summary**  
...
* **-te**,&nbsp;**--end**&nbsp;[_end-date_]&nbsp;[_end-time_]  
  ...
  **this-year**. **Today** means starting now. **Recent** is 10 minutes
  ago. **Yesterday** is 1 second after midnight the previous day.
  **This-week** means starting 1 second after midnight on day 0 of the week
  determined by your locale (see **localtime**). **This-month** means 1
  second after midnight on day 1 of the month. **This-year** means the 1
