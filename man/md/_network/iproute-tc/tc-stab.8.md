...
power of 2 value, so the whole **mtu** is covered by the size table. Neither
**tsize**, nor **mtu** have to be power of 2 value, so the size
...
* ·  
  ...
  minimum 2 atm cells. You should set **mpu** accordingly for that.
* ·  
