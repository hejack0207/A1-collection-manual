...
<a name="adsl-overhead-keywords"></a>
...
<a name="vdsl2-overhead-keywords"></a>
...
<a name="docsis-cable-overhead-keyword"></a>
...
<a name="ethernet-overhead-keywords"></a>
...
as 'bulk', the following filter can be used:
        ...
        # tc filter add dev eth0 parent 1: protocol ip prio 1 &nbsp;         u32 match icmp type 0 0 action skbedit priority 1:1
...
to the Linux Networking mailing list &lt;[netdev@vger.kernel](mailto:netdev@vger.kernel).org&gt;.
