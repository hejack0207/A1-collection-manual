# bpf classifier and actions in tc(8) - BPF programmable classifier and actions for ingress/egress
...
<a name="ebpf-classifier-filter-or-action"></a>
...
<a name="cbpf-classifier-filter-or-action"></a>
...
<a name="direct-action-da"></a>

### direct-action | da

instructs eBPF classifier to not invoke external TC actions, instead use the
TC actions return codes (**TC\_ACT\_OK**, **TC\_ACT\_SHOT** etc.) for
classifiers.


<a name="skip_hw-skip_sw"></a>
...
mailing list:
**&lt;[netdev@vger.kernel](mailto:netdev@vger.kernel).org&gt;**
