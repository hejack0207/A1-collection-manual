...
vSwitch has the name **Open\_vSwitch**.  Schema names begin with a
...
<a name="standalone-database-service-model"></a>
...
See _Connection Methods_ below for information about connection methods.

<a name="active-backup-database-service-model"></a>
...
&lt;active&gt; is an OVSDB connection method (see _Connection Methods_ below) that
...
<a name="clustered-database-service-model"></a>
...
the servers’ connection methods, comma-separated.  See _Connection Methods_,
below, for more detail.

Open vSwitch 2.9 introduced support for the clustered service model.

<a name="how-to-maintain-a-clustered-database"></a>
...
schema, which is covered later under _Upgrading or Downgrading a Database_.)
...
<a name="understanding-cluster-consistency"></a>
...
<a name="backing-up-and-restoring-a-database"></a>
...
_Database Replication_ which keeps an online, up-to-date
...
<a name="changing-database-service-model"></a>
...
<a name="upgrading-or-downgrading-a-database"></a>
...
clients that use the **set\_db\_change\_aware** Open vSwitch extension RPC).  Upon
reconnection, clients will discover that the schema has changed.

Schema versions and checksums (see _Schemas_ above) can give hints about whether
...
<a name="working-with-database-history"></a>
