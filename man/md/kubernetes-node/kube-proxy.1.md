...
**--bind-address 0.0.0.0                         The IP address for the proxy server to serve on (set to 0.0.0.0 for all IPv4 interfaces and \fC**
    : for all IPv6 interfaces) (default 0.0.0.0)



      --cleanup                                      If true cleanup iptables and ipvs rules and exit.
      --cleanup-ipvs                                 If true and --cleanup is specified, kube-proxy will also flush IPVS rules, in addition to normal cleanup. (default true)
...
**--healthz-bind-address 0.0.0.0                 The IP address for the health check server to serve on (set to 0.0.0.0 for all IPv4 interfaces and \fC**
    : for all IPv6 interfaces) (default 0.0.0.0:10256)
...
-h, --help                                         help for kube-proxy
      ...
      --ipvs-strict-arp                              Enable strict ARP by setting arp\_ignore to 1 and arp\_announce to 2
...
**--metrics-bind-address 0.0.0.0                 The IP address for the metrics server to serve on (set to 0.0.0.0 for all IPv4 interfaces and \fC**
    : for all IPv6 interfaces) (default 127.0.0.1:10249)
...
**--proxy-mode ProxyMode                         Which proxy mode to use**
     'userspace' (older) or 'iptables' (faster) or 'ipvs' (experimental). If blank, use the best-available proxy (currently iptables).  If the iptables proxy is selected, regardless of how, but the system's kernel or iptables versions are insufficient, this always falls back to the userspace proxy.
