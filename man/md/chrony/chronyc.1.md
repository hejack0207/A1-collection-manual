...
_/run/chrony/chronyd.sock_. If that fails (e.g. because **chronyc** is
...
_local_ mode operating (via the **local** command in **chronyc**, or the
...
**Leap status**
This is the leap status, which can be _Normal_, _Insert second_, Delete
second or _Not synchronised_.
...
**waitsync** [_max-tries_ [_max-correction_ [_max-skew_ [_interval_]]]]
...
.el \{.  sp -1
.\}
<i>\*</i> indicates the best source which is currently selected for
synchronisation.
...
.el \{.  sp -1
.\}
<i>\*</i> - selected as the best source to update the reference data (e.g. root
...
**Score**
This column displays the current score against the source in the <i>\*</i> state. The
...
<i>\*</i> source in recent selections. If the score reaches 10, the best source will
...
offline. If the **auto\_offline** option is used in specifying some of the servers
...
**burst** _good_/_max_ [_mask_/_masked-address_], **burst** _good_/_max_ [_masked-address_/_masked-bits_], **burst** _good_/_max_ [_address_]
...
**maxdelaydevratio** _address_ _ratio_
...
**maxdelayratio** _address_ _ratio_
...
**minstratum** _address_ _minstratum_
...
**offline** [_address_], **offline** [_masked-address_/_masked-bits_], **offline** [_mask_/_masked-address_]
...
**online** [_address_], **online** [_masked-address_/_masked-bits_], **online** [_mask_/_masked-address_]
...
**polltarget** _address_ _polltarget_
...
<a name="manual-time-input"></a>

### Manual time input


**manual** **on**, **manual** **off**, **manual** **delete** _index_, **manual** **list**, **manual** **reset**
...
<a name="monitoring-access"></a>

### Monitoring access


**cmdaccheck** _address_
...
<a name="other-daemon-commands"></a>
