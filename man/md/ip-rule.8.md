...
```
 ...
 .in +8 .ti -8 ip [ OPTIONS ] rule { COMMAND |  help } 

</synopsis>

<synopsis>
.ti -8  ip rule [ list [ SELECTOR ]]
</synopsis>

<synopsis>
.ti -8  ip rule { add | del }  SELECTOR ACTION
</synopsis>

<synopsis>
.ti -8 ip rule { flush | save | restore }
</synopsis>

<synopsis>
.ti -8 SELECTOR := [  not ] [  from PREFIX ] [   to PREFIX ] [   tos TOS ] [   fwmark FWMARK[/MASK] ] [   iif STRING ] [   oif STRING ] [   pref NUMBER ] [  l3mdev ] [  uidrange NUMBER-NUMBER ] [  ipproto PROTOCOL ] [  sport [  NUMBER |  NUMBER-NUMBER ] ] [  dport [  NUMBER |  NUMBER-NUMBER ] ] [   tun_id TUN_ID ]

</synopsis>


<synopsis>
.ti -8 ACTION := [   table TABLE_ID ] [   protocol PROTO ] [   nat ADDRESS ] [  realms [SRCREALM/]DSTREALM ] [ goto NUMBER ] SUPPRESSOR
</synopsis>

<synopsis>
.ti -8 SUPPRESSOR := [   suppress_prefixlength NUMBER ] [   suppress_ifgroup GROUP ]
</synopsis>

<synopsis>
.ti -8 TABLE_ID := [  local | main | default | NUMBER ]
```
...
* **ip rule delete - delete a rule**  
    ...
    * **suppress_prefixlength**_ NUMBER_  
      reject routing decisions that have a prefix length of NUMBER or less.
      
    * **suppress_ifgroup**_ GROUP_  
