...
RELEASE_STRING-RELEASE_VERSION, RELEASE_DATE

```
.SY dkms .OP action .OP options .OP module/module-version .OP /path/to/source-tree .OP /path/to/tarball.tar .OP /path/to/driver.rpm .YS
```
...
* ""  
  ...
  requires source in
  _/usr/src/&lt;module&gt;-&lt;module-version&gt;/_
  as well as a properly
  formatted
  _dkms.conf_
  file. If
  _/path/to/source-tree_
...
* ""  
  ...
  _/var/lib/dkms/&lt;module&gt;/&lt;module-version&gt;/build/._
...
* ""  
  ...
  **-d redhat3**
  ...
  _/etc/dkms/template-dkms-redhat-kmod.spec_
...
* ""  
  ...
  _/etc/dkms/template-dkms-mkrpm.spec_
  as the basis for the RPM.  Alternatively, if DKMS finds a file called
  _/usr/src/&lt;module&gt;-&lt;module-version&gt;/&lt;module&gt;-dkms-mkrpm.spec_
...
* ""  
  ...
  _/etc/dkms/template-dkms-mkdeb_
  as the basis for the package. Alternatively, if DKMS finds a file called
  _/usr/src/&lt;module&gt;-&lt;module-version&gt;/&lt;module&gt;-dkms-mkdeb_
...
* ""  
  ...
  It uses a template debian directory found in
  _/etc/dkms/template-dkms-mkbmdeb_
...
* ""  
  ...
  **mkdeb**
  ...
  _/etc/dkms/template-dkms-mkdsc_
  as the basis for the package. Alternatively, if DKMS finds a file called
  _/usr/src/&lt;module&gt;-&lt;module-version&gt;/&lt;module&gt;-dkms-mkdsc_
...
* **--config &lt;kernel-.config-location&gt;**  
  ...
  **dkms**
  ...
  _/usr/src/linux-&lt;kernel&gt;/configs/._
...
* **--kernelsourcedir &lt;kernel-source-directory-location&gt;**  
  ...
  _/lib/modules/$kernel_version/build._
...
_/lib/modules/&lt;kernelversion&gt;/updates/_
followed by
...
_/var/lib/dkms/&lt;module&gt;/original_module/$kernelver/collisions_
...
* **PATCH[#]=**  
  ...
  _/usr/src/&lt;module&gt;-&lt;module-version&gt;/patches/_
...
* **AUTOINSTALL=**  
  ...
  **yes**
  then the service
  _/etc/rc.d/init.d/dkms_autoinstaller_
...
* **$kernel_source_dir**  
  ...
  will be
  _/lib/modules/$kernelver/build_
  , unless otherwise specified with the
  **--kernelsourcedir**
  option.

<a name="dkmsconf-overrides"></a>
...
_/etc/dkms/&lt;module&gt;.conf_  
_/etc/dkms/&lt;module&gt;-&lt;module-version&gt;.conf_  
_/etc/dkms/&lt;module&gt;-&lt;module-version&gt;-&lt;kernel&gt;.conf_  
_/etc/dkms/&lt;module&gt;-&lt;module-version&gt;-&lt;kernel&gt;-&lt;arch&gt;.conf_

You can use these files to override settings in the module-provided dkms.conf files.

<a name="etcdkmsframeworkconf"></a>
...
<a name="modulesconf-modprobeconf-changes"></a>
...
_https://github.com/dell/dkms_

<a name="white-papers"></a>

# White\-Papers

_http://www.dell.com/downloads/global/power/1q04-ler.pdf_

_http://www.linuxjournal.com/article.php?sid=6896_
...
dkms-devel@dell.com
_http://lists.us.dell.com/mailman/listinfo/dkms-devel_
...
_http://kerneldrivers.org_

Novell Kernel Module Packages
_http://www.suse.de/~agruen/KMPM_

Fedora Kernel Module Packages
_http://fedoraproject.org/wiki/Extras/KernelModuleProposal_
