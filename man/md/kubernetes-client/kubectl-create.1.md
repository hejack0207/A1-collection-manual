...
**kubectl(1)**, **kubectl-create-clusterrole(1)**, **kubectl-create-clusterrolebinding(1)**, **kubectl-create-configmap(1)**, **kubectl-create-cronjob(1)**, **kubectl-create-deployment(1)**, **kubectl-create-job(1)**, **kubectl-create-namespace(1)**, **kubectl-create-poddisruptionbudget(1)**, **kubectl-create-priorityclass(1)**, **kubectl-create-quota(1)**, **kubectl-create-role(1)**, **kubectl-create-rolebinding(1)**, **kubectl-create-secret(1)**, **kubectl-create-service(1)**, **kubectl-create-serviceaccount(1)**,
