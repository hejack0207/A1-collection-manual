...
<synopsis>
-h --help -i --short-info -l -s --long-info -n --numeric -f --full-table -1 --separate-lines -Sshape --shape=shape -t --funcs-only -k --keys-only -d --compose-only -ccharset --charset=charset -v --verbose -V --version ]
```
...
.IX "dumpkeys command" "" "\fLdumpkeys command"  
...
* **-c**_charset_** **_ _**--charset=**_charset_  
  This instructs
  **dumpkeys**
