...
<a name="symbolic-link-ownership-permissions-and-timestamps"></a>
...
<a name="obtaining-a-file-descriptor-that-refers-to-a-symbolic-link"></a>
...
<a name="handling-of-symbolic-links-by-system-calls-and-commands"></a>
...
<a name="commands-not-traversing-a-file-tree"></a>
...
<a name="commands-traversing-a-file-tree"></a>
...
The _first rule_ applies to symbolic links that reference files other
than directories.
Operations that apply to symbolic links are performed on the links
themselves, but otherwise the links are ignored.

The command
_rm&nbsp;-r slink directory_
will remove
_slink_,
...
The _second rule_ applies to symbolic links that refer to directories.
