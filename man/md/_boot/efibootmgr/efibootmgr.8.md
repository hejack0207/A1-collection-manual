# efibootmgr(8) - manipulate the UEFI Boot Manager
...
**efibootmgr** is a userspace application used to modify the UEFI Boot
...
_/sys/firmware/efi/vars_ or _/sys/firmware/efi/efivars/_.
...
* **-l | --loader NAME**  
  Specify a loader (defaults to _\\\\elilo.efi_)
* **-L | --label LABEL**  
...
* **-t | --timeout seconds**  
  Boot Manager timeout, in _seconds_.
* **-T | --delete-timeout**  
...
<a name="displaying-the-current-settings-must-be-root"></a>
...
<a name="creating-a-new-boot-option"></a>

### Creating a new boot option

An OS installer would call **efibootmgr -c**.
This assumes that _/boot/efi_ is your EFI System
Partition, and is mounted at _/dev/sda1_. This
...
behavior. The default OS Loader is _elilo.efi_.

<a name="changing-the-boot-order"></a>
...
<a name="changing-the-boot-order-for-the-next-boot-only"></a>
...
<a name="deleting-a-boot-option"></a>
...
<a name="creating-network-boot-entries"></a>
...
This man page was generated by dann frazier &lt;[dannf@debian.org](mailto:dannf@debian.org)&gt; for the
Debian GNU/Linux operating system and updated by Robert Bisewski
&lt;[contact@ibiscybernetics.com](mailto:contact@ibiscybernetics.com)&gt;, but may be used by others.
