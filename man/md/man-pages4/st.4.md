...
_/usr/include/linux/mtio.h_:

<a name="mtioctop-em-perform-a-tape-operation"></a>

### MTIOCTOP \(em perform a tape operation
...
<a name="mtiocget-em-get-status"></a>

### MTIOCGET \(em get status
...
* _mt\_gstat_  
  ...
  The header file defines macros for testing these status bits:
      ...
      **open**(2)
      ...
      .HP
      **GMT\_D\_6250**(_x_), **GMT\_D\_1600**(_x_), **GMT\_D\_800**(_x_):
...
<a name="mtiocpos-em-get-tape-position"></a>

### MTIOCPOS \(em get tape position
