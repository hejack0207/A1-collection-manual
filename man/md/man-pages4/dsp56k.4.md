...
The _dsp56k_ special file is used to control the DSP56001, and
...
* **DSP56K\_UPLOAD**  
  ...
  The third
  **ioctl**(2)
  argument must be a pointer to a _struct dsp56k\_binary_ with members
  _bin_ pointing to a DSP56001 binary program, and _len_ set to
...
* To access the host flags, the third
  **ioctl**(2)
  ...
  to a _struct dsp56k\_host\_flags_.
  If bit 0 or 1 is set in the
  _dir_ member, the corresponding bit in _out_ will be written
  to the host flags.
  The state of all host flags will be returned in
  the lower four bits of the _status_ member.
* **DSP56K\_HOST\_CMD**  
...
_linux/include/asm-m68k/dsp56k.h_,
_linux/drivers/char/dsp56k.c_,
