...
The _xstdcmap_ utility can be used to selectively define standard colormap
...
The following options may be used with _xstdcmap_:
...
* **-all**  
  ...
  _xstdcmap_ will determine the best
...
* **-delete _map_**  
  ...
  _map_ may be one of: default, best, red, green, blue, gray, or all.
* **-display _display_**  
  This option specifies the host and display to use; see _X(7)_.
* **-gray**  
...
* **-verbose**  
  This option indicates that _xstdcmap_ should
  print logging information as it parses its input and defines the
  standard colormap properties.
* **-version**  
  This option indicates that _xstdcmap_ should print its version and exit.
