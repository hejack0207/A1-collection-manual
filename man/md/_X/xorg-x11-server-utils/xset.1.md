...
* **-display _display_**  
  This option specifies the server to use; see _X(7)_.
...
* **bc**  
  The **bc** option controls _bug compatibility_ mode in the server,
...
* **fp **rehash****  
  ...
  a font directory (after running _mkfontdir_ to recreate the font database).
...
* **r**  
  ...
  Invoking with "**-r**", or "**r&nbsp;off**", will disable autorepeat, whereas
  "**r**", or "**r&nbsp;on**" will enable autorepeat.
  Following the "**-r**" or "**r**" option with an integer keycode between 0 and
  ...
  not typically valid for this command.  Example: "**xset&nbsp;-r&nbsp;10**" will
...
Manpage updates added by Mike A. Harris &lt;[mharris@redhat.com](mailto:mharris@redhat.com)&gt;
