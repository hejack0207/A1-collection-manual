...
* **-isolateDevice _bus-id_**  
  Restrict device resets to the device at
  _bus-id_.
  The
  _bus-id_
  string has the form
  _bustype_**:**_bus_**:**_device_**:**_function_
  (e.g., ‘PCI:1:0:0’).
...
* **-logfile**_ filename_  
  ...
  **/var/log/Xorg.**_n_**.log**
  and for non root it is
  **$XDG_DATA_HOME/xorg/Xorg.**_n_**.log**
  where
  _n_
...
That was originally based on _X386 1.2_ by Thomas Roell, which
...
_&lt;ftp://ftp.x.org/&gt;_, and from the X.Org
server _&lt;https://gitlab.freedesktop.org/xorg/&gt;_.  Documentation and other
...
**Xorg is copyright by numerous authors and**
