...
<a name="important-note-to-nvidia-binary-driver-users"></a>

### IMPORTANT NOTE TO nVidia BINARY DRIVER USERS


If you are using the nVidia binary graphics driver (also known as _blob_) before version 302.17, you need to use the --force-xinerama flag (in your ~/.xsession) when starting i3, like so:
...
<a name="configi3config-or-i3config"></a>
...
You can also access these documents online at \m[blue]**https://i3wm.org/**\m[]
