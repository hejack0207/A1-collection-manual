...
**--address ip                                                     The IP address on which to serve the insecure --port (set to 0.0.0.0 for all IPv4 interfaces and **
    : for all IPv6 interfaces). (default 0.0.0.0) (DEPRECATED: see --bind-address instead.)
...
**--enable-taint-manager                                           WARNING**
     Beta feature. If set to true enables NoExecute Taints and will evict all not-tolerating Pod running on Nodes tainted with this kind of Taints. (default true)
...
-h, --help                                                           help for kube-controller-manager
      ...
      --leader-elect-resource-lock endpoints                           The type of resource object that is used for locking during leader election. Supported options are endpoints (default) and **\fCconfigmaps**. (default "endpoints")
...
**--port int                                                       The port on which to serve unsecured, unauthenticated access. Set to 0 to disable. (default 10252) (DEPRECATED**
