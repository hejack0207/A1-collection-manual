...
```
.IX Header "SYNOPSIS" .Vb 1  virt-copy-out -a disk.img /file|dir [/file|dir ...] localdir   virt-copy-out -d domain /file|dir [/file|dir ...] localdir .Ve
```
...
\f(CW`virt-copy-out\*(C' copies files and directories out of a virtual machine
...
**guestfish**\|(1) \f(CW`copy-out\*(C' command.  For anything more complex than a
