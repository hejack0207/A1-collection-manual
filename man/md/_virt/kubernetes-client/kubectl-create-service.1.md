...
**kubectl-create(1)**, **kubectl-create-service-clusterip(1)**, **kubectl-create-service-externalname(1)**, **kubectl-create-service-loadbalancer(1)**, **kubectl-create-service-nodeport(1)**,
