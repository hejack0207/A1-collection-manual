...
#### []{#basic_ops_modify_topic .anchor-link}[Modifying topics](#basic_ops_modify_topic) {#modifying-topics .anchor-heading}
...
#### []{#basic_ops_consumer_group .anchor-link}[Managing Consumer Groups](#basic_ops_consumer_group) {#managing-consumer-groups .anchor-heading}
...
##### []{#basic_ops_automigrate .anchor-link}[Automatically migrating data to new machines](#basic_ops_automigrate) {#automatically-migrating-data-to-new-machines .anchor-heading}
...
#### []{#basic_ops_increase_replication_factor .anchor-link}[Increasing replication factor](#basic_ops_increase_replication_factor) {#increasing-replication-factor .anchor-heading}
...
#### []{#rep-throttle .anchor-link}[Limiting Bandwidth Usage during Data Migration](#rep-throttle) {#limiting-bandwidth-usage-during-data-migration .anchor-heading}
...
#### []{#georeplication-overview .anchor-link}[Geo-Replication Overview](#georeplication-overview) {#geo-replication-overview .anchor-heading}
...
##### []{#georeplication-topic-naming .anchor-link}[Custom Naming of Replicated Topics in Target Clusters](#georeplication-topic-naming) {#custom-naming-of-replicated-topics-in-target-clusters .anchor-heading}
...
##### []{#georeplication-example-active-active .anchor-link}[Example: Active/Active High Availability Deployment](#georeplication-example-active-active) {#example-activeactive-high-availability-deployment .anchor-heading}
...
#### []{#multitenancy-security .anchor-link}[Securing Clusters and Topics: Authentication, Authorization, Encryption](#multitenancy-security) {#securing-clusters-and-topics-authentication-authorization-encryption .anchor-heading}
...
#### []{#diskandfs .anchor-link}[Disks and Filesystem](#diskandfs) {#disks-and-filesystem .anchor-heading}
...
### []{#monitoring .anchor-link}[6.8 Monitoring](#monitoring) {#monitoring .anchor-heading}
...
#### [Common monitoring metrics for producer/consumer/connect/streams](#selector_monitoring){#selector_monitoring}
...
#### [Common Per-broker metrics for producer/consumer/connect/streams](#common_node_monitoring){#common_node_monitoring}
...
#### []{#producer_monitoring .anchor-link}[Producer monitoring](#producer_monitoring) {#producer-monitoring .anchor-heading}
...
##### []{#producer_sender_monitoring .anchor-link}[Producer Sender Metrics](#producer_sender_monitoring) {#producer-sender-metrics .anchor-heading}

#### []{#consumer_monitoring .anchor-link}[consumer monitoring](#consumer_monitoring) {#consumer-monitoring .anchor-heading}
...
##### []{#consumer_group_monitoring .anchor-link}[Consumer Group Metrics](#consumer_group_monitoring) {#consumer-group-metrics .anchor-heading}
...
##### []{#consumer_fetch_monitoring .anchor-link}[Consumer Fetch Metrics](#consumer_fetch_monitoring) {#consumer-fetch-metrics .anchor-heading}

#### []{#connect_monitoring .anchor-link}[Connect Monitoring](#connect_monitoring) {#connect-monitoring .anchor-heading}
...
#### []{#kafka_streams_monitoring .anchor-link}[Streams Monitoring](#kafka_streams_monitoring) {#streams-monitoring .anchor-heading}
...
##### []{#kafka_streams_client_monitoring .anchor-link}[Client Metrics](#kafka_streams_client_monitoring) {#client-metrics .anchor-heading}
...
##### []{#kafka_streams_thread_monitoring .anchor-link}[Thread Metrics](#kafka_streams_thread_monitoring) {#thread-metrics .anchor-heading}
...
##### []{#kafka_streams_task_monitoring .anchor-link}[Task Metrics](#kafka_streams_task_monitoring) {#task-metrics .anchor-heading}
...
##### []{#kafka_streams_node_monitoring .anchor-link}[Processor Node Metrics](#kafka_streams_node_monitoring) {#processor-node-metrics .anchor-heading}
...
##### []{#kafka_streams_store_monitoring .anchor-link}[State Store Metrics](#kafka_streams_store_monitoring) {#state-store-metrics .anchor-heading}
...
##### []{#kafka_streams_rocksdb_monitoring .anchor-link}[RocksDB Metrics](#kafka_streams_rocksdb_monitoring) {#rocksdb-metrics .anchor-heading}
...
##### []{#kafka_streams_cache_monitoring .anchor-link}[Record Cache Metrics](#kafka_streams_cache_monitoring) {#record-cache-metrics .anchor-heading}
...
#### []{#others_monitoring .anchor-link}[Others](#others_monitoring) {#others .anchor-heading}
...
### []{#zk .anchor-link}[6.9 ZooKeeper](#zk) {#zookeeper .anchor-heading}

#### []{#zkversion .anchor-link}[Stable version](#zkversion) {#stable-version .anchor-heading}

The current stable branch is 3.5. Kafka is regularly updated to include
the latest release in the 3.5 series.

#### []{#zkops .anchor-link}[Operationalizing ZooKeeper](#zkops) {#operationalizing-zookeeper .anchor-heading}
