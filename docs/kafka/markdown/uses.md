...
#### []{#uses_messaging .anchor-link}[Messaging](#uses_messaging) {#messaging .anchor-heading}
...
#### []{#uses_website .anchor-link}[Website Activity Tracking](#uses_website) {#website-activity-tracking .anchor-heading}
...
#### []{#uses_metrics .anchor-link}[Metrics](#uses_metrics) {#metrics .anchor-heading}
...
#### []{#uses_logs .anchor-link}[Log Aggregation](#uses_logs) {#log-aggregation .anchor-heading}
...
#### []{#uses_streamprocessing .anchor-link}[Stream Processing](#uses_streamprocessing) {#stream-processing .anchor-heading}
...
#### []{#uses_eventsourcing .anchor-link}[Event Sourcing](#uses_eventsourcing) {#event-sourcing .anchor-heading}
...
#### []{#uses_commitlog .anchor-link}[Commit Log](#uses_commitlog) {#commit-log .anchor-heading}
