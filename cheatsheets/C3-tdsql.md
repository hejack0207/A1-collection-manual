...
# client side
* mysql -hHOST -uUSER -pPASSWD -PPORT -e 'select table_name,table_schema from information_schema.tables where table_name like "%SYNC%";'
* mysql -hHOST -uUSER -pPASSWD -PPORT -e 'select * from DB.TABLE limit 1\G;'
